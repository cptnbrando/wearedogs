...
export const NEIGHBOR_STATS = [
  ...
  },
  {
    ...
    note: "Deliberately blank: Louisiana publishes no clean annual retail total. The programme is tiny — 9 dispensaries supplied by 2 growers — and therapeutic-marijuana fees came to $6.36M in FY2024/25. A $106M \"Marijuana & Controlled Dangerous Substance\" tax line exists but is not cannabis-retail specific, so it is not used here.",
  },
  {
