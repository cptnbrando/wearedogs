    ...
    <div class="panel-body">
      {#if activeApp === null}
        ...
        <div class="launcher-view animated-pane">
          {#if focusedIdx >= 0}
            <div class="kb-hint">Arrow keys to navigate &nbsp;·&nbsp; Enter to open &nbsp;·&nbsp; Esc to close</div>
          {/if}
          <div class="apps-grid" bind:this={appsGridEl}>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 0} style="--card-color: #b455ff"
              onclick={() => { activeApp = 'gopro'; }} onmouseenter={() => { focusedIdx = 0; }}>
              <div class="app-visual"><div class="video-preview-mini"><span class="lens"></span><span class="tape t1"></span><span class="tape t2"></span></div></div>
              <div class="app-meta"><span class="app-title"><Video size={14} /> GoPro Cinema</span><span class="app-desc">Stream retro TV series and clip custom audio loops.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 1} style="--card-color: #00d7ff"
              onclick={() => { activeApp = 'dataflash'; }} onmouseenter={() => { focusedIdx = 1; }}>
              <div class="app-visual"><Zap size={28} style="color: #00d7ff; filter: drop-shadow(0 0 6px rgba(0,215,255,0.4));" /></div>
              <div class="app-meta"><span class="app-title"><Zap size={14} /> DataFlash</span><span class="app-desc">Visual file transfer protocol over flashing QR codes.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 2} style="--card-color: #00bfff"
              onclick={() => { activeApp = 'qrgenerator'; }} onmouseenter={() => { focusedIdx = 2; }}>
              <div class="app-visual"><div class="qr-preview-mini"><span class="corner c1"></span><span class="corner c2"></span><span class="corner c3"></span><div style="width:4px;height:4px;background:#00d7ff;border-radius:50%;box-shadow:0 0 6px #00d7ff;"></div></div></div>
              <div class="app-meta"><span class="app-title"><QrCode size={14} /> QR Generator</span><span class="app-desc">Generate resizable QR codes with custom center logo overlays.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 3} style="--card-color: #ff55bb"
              onclick={() => { activeApp = 'soundboard'; }} onmouseenter={() => { focusedIdx = 3; }}>
              <div class="app-visual"><div class="wave-preview"><span></span><span></span><span></span><span></span><span></span></div></div>
              <div class="app-meta"><span class="app-title"><Volume2 size={14} /> Dog Soundboard</span><span class="app-desc">Play high fidelity dog bark synthesizers.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 4} style="--card-color: #00bfff"
              onclick={() => { activeApp = 'snake'; }} onmouseenter={() => { focusedIdx = 4; }}>
              <div class="app-visual"><div class="snake-mini-preview"><span class="dot d1"></span><span class="dot d2"></span><span class="dot d3"></span><span class="dot d4"></span></div></div>
              <div class="app-meta"><span class="app-title"><Award size={14} /> Snake</span><span class="app-desc">Retro snake game, runs inside grid. Use Arrow Keys.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 5} style="--card-color: #ffcc00"
              onclick={() => { activeApp = 'paint'; }} onmouseenter={() => { focusedIdx = 5; }}>
              <div class="app-visual"><div class="brush-preview"><Paintbrush size={32} /><span class="drip"></span></div></div>
              <div class="app-meta"><span class="app-title"><Paintbrush size={14} /> Sketch Canvas</span><span class="app-desc">Draw and paint illustrations on a canvas.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 6} style="--card-color: #00ff66"
              onclick={() => { activeApp = 'stopwatch'; }} onmouseenter={() => { focusedIdx = 6; }}>
              <div class="app-visual"><div class="stopwatch-preview"><Hourglass size={32} /></div></div>
              <div class="app-meta"><span class="app-title"><Hourglass size={14} /> Father Time</span><span class="app-desc">Sands of time: stopwatch, timer, alarms, world clock, metronome &amp; pitch tuner.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 7} style="--card-color: #00d7ff"
              onclick={() => { activeApp = 'rescue'; }} onmouseenter={() => { focusedIdx = 7; }}>
              <div class="app-visual"><div class="rescue-preview"><Radio size={32} /></div></div>
              <div class="app-meta"><span class="app-title"><Radio size={14} /> Rescue Ops</span><span class="app-desc">Coordinate search-and-rescue beacons and flight paths.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 8} style="--card-color: #ff55bb"
              onclick={() => { activeApp = 'memes'; }} onmouseenter={() => { focusedIdx = 8; }}>
              <div class="app-visual"><div class="memes-preview"><Smile size={32} /></div></div>
              <div class="app-meta"><span class="app-title"><Smile size={14} /> Canine Memes</span><span class="app-desc">Explore and share high-fidelity, hilarious dog memes.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 9} style="--card-color: #e6b900"
              onclick={() => { activeApp = 'worldcup'; }} onmouseenter={() => { focusedIdx = 9; }}>
              <div class="app-visual"><div class="wc-bracket-preview"><Trophy size={32} /></div></div>
              <div class="app-meta"><span class="app-title"><Trophy size={14} /> FIFA World Cup</span><span class="app-desc">Track matches, group stage standings, and the bracket.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 10} style="--card-color: #00ff66"
              onclick={() => { activeApp = 'changelog'; }} onmouseenter={() => { focusedIdx = 10; }}>
              <div class="app-visual"><div class="terminal-preview-mini"><span class="prompt-symbol">&gt;_</span><span class="cursor-blink"></span></div></div>
              <div class="app-meta"><span class="app-title"><Terminal size={14} /> Changelog</span><span class="app-desc">View the system changelog and repository development metrics.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 11} style="--card-color: #b455ff"
              onclick={() => { activeApp = 'blog'; }} onmouseenter={() => { focusedIdx = 11; }}>
              <div class="app-visual"><div class="blog-preview-mini"><span class="line l1"></span><span class="line l2"></span><span class="line l3"></span></div></div>
              <div class="app-meta"><span class="app-title"><BookOpen size={14} /> DOG BLOG</span><span class="app-desc">Read articles about punk rock tech, development, and music.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 12} style="--card-color: #ff55bb"
              onclick={() => { activeApp = 'soundstripper'; }} onmouseenter={() => { focusedIdx = 12; }}>
              <div class="app-visual"><div class="flex items-center justify-center h-full"><Scissors size={28} style="color: #ff007f; filter: drop-shadow(0 0 6px rgba(255,0,127,0.4));" /></div></div>
              <div class="app-meta"><span class="app-title"><Scissors size={14} /> Sound Stripper</span><span class="app-desc">Extract vocal acapellas by subtracting reference instrumental bleed.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 13} style="--card-color: #00d7ff"
              onclick={() => { activeApp = 'windshieldwiper'; }} onmouseenter={() => { focusedIdx = 13; }}>
              <div class="app-visual"><div class="flex items-center justify-center h-full relative overflow-hidden"><div class="wiper-icon-container"><svg viewBox="0 0 100 100" class="w-12 h-12"><path d="M 15 80 A 45 45 0 0 1 85 80" fill="none" stroke="rgba(255,255,255,0.08)" stroke-width="6" stroke-linecap="round" /><line x1="50" y1="85" x2="50" y2="40" stroke="#00ffff" stroke-width="4" stroke-linecap="round" class="wiper-blade-animate" /></svg></div></div></div>
              <div class="app-meta"><span class="app-title"><Sparkles size={14} /> Windshield Wiper</span><span class="app-desc">Clean watermarks and logos from images and videos using canvas magic.</span></div>
            </div>

            <!-- svelte-ignore a11y_click_events_have_key_events -->
            <!-- svelte-ignore a11y_no_static_element_interactions -->
            <div class="app-card" class:focused={focusedIdx === 14} style="--card-color: #ff3344"
              onclick={() => { activeApp = 'settings'; }} onmouseenter={() => { focusedIdx = 14; }}>
              <div class="app-visual"><div class="settings-preview-mini"><Settings size={28} class="animate-spin-slow text-white/50" /></div></div>
              <div class="app-meta"><span class="app-title"><Settings size={14} /> Settings</span><span class="app-desc">Customize site-wide themes and UI profiles.</span></div>
            </div>
