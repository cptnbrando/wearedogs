...
import{$n as e,A as t,C as n,Er as r,Et as i,Fn as a,Ft as o,Gr as s,H as c,Hr as l,Ht as u,Ir as d,It as f,J as p,K as m,Kr as h,L as g,Lr as _,Mn as ee,Mr as v,Nr as te,Or as ne,P as re,Rr as ie,S as ae,Sr as y,St as oe,Tr as b,Ur as x,Vt as se,Wr as ce,Wt as le,Xr as S,Y as ue,Yn as de,Zr as C,Zt as fe,_i as w,_r as pe,ai as T,ar as me,bt as he,cr as ge,ei as _e,g as ve,gi as E,hi as ye,hr as D,j as be,jr as O,kr as xe,li as k,lr as Se,mi as Ce,mr as we,ni as Te,oi as A,pt as Ee,qn as De,ri as j,si as Oe,sn as ke,st as Ae,ti as M,tn as je,ur as Me,vi as N,vr as Ne,xr as Pe,xt as Fe,yn as Ie,zr as P,zt as Le}from"./vendor-DfMWaZoH.js";import{t as Re}from"./index-B_z93SWi.js";import{t as F}from"./AudioCore.svelte-BjfToHPE.js";import{t as ze}from"./DogsLogo-D4aFPQNd.js";import{t as Be}from"./settingsManager.svelte-Bp1LFZws.js";import{t as Ve}from"./SwipeTabNav-B75MIc5S.js";var He=class{constructor(e,t){N(this,`canvas`,null),N(this,`gl`,null),N(this,`analyser`,null),N(this,`program`,null),N(this,`animationFrameId`,null),N(this,`startTime`,0),N(this,`vertexBuffer`,null),N(this,`audioTexture`,null),N(this,`uniforms`,{}),N(this,`frequencyBuffer`,null),this.canvas=e,this.analyser=t,this.frequencyBuffer=new Uint8Array(t?t.frequencyBinCount:128),this.gl=e.getContext(`webgl`)||e.getContext(`experimental-webgl`),this.gl||console.error(`WebGL not supported by this browser.`)}init(e){if(!this.gl)return;let t=this.gl;this.cleanupProgram();let n=this.compileShader(t.VERTEX_SHADER,`
