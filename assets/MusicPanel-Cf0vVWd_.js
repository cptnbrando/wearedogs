import{$i as e,Ai as t,C as n,Ci as r,Fi as i,Hi as a,Ii as o,Ir as s,Jr as c,Jt as l,Ki as u,L as d,Li as f,M as p,Mr as m,Mt as h,Nt as g,Pn as _,Qi as ee,Qr as v,Ri as y,Rr as b,Rt as te,S as ne,Si as re,Ui as x,Ur as ie,V as ae,Wi as oe,Wr as S,X as se,Xn as ce,Yt as le,Zi as ue,Zr as C,_ as de,_r as fe,ai as pe,at as me,bi as w,ci as T,ea as E,gi as D,hi as he,ii as ge,it as _e,j as ve,jt as ye,ki as O,li as be,ln as xe,mi as k,ni as Se,nr as Ce,nt as we,oi as Te,pi as A,pn as Ee,qr as De,rn as Oe,ta as j,tn as ke,ui as Ae,wi as je,xi as M,yi as Me,yn as Ne,yt as Pe,zr as N}from"./vendor-Bb9i1iAG.js";import{n as Fe,r as Ie,t as P}from"./AudioCore.svelte-BExPe7qe.js";import{t as Le}from"./DogsLogo-CIdlEuGQ.js";import{t as Re}from"./doubleTap-C15pvH0v.js";import{t as ze}from"./settingsManager.svelte-CJ7c0L62.js";var Be=class{constructor(e,t){j(this,`canvas`,null),j(this,`gl`,null),j(this,`analyser`,null),j(this,`program`,null),j(this,`animationFrameId`,null),j(this,`startTime`,0),j(this,`vertexBuffer`,null),j(this,`audioTexture`,null),j(this,`uniforms`,{}),j(this,`frequencyBuffer`,null),this.canvas=e,this.analyser=t,this.frequencyBuffer=new Uint8Array(t?t.frequencyBinCount:128),this.gl=e.getContext(`webgl`)||e.getContext(`experimental-webgl`),this.gl||console.error(`WebGL not supported by this browser.`)}init(e){if(!this.gl)return;let t=this.gl;this.cleanupProgram();let n=this.compileShader(t.VERTEX_SHADER,`
    ...
    `}],He={id:`no-signal`,name:`No Signal`,fragmentShader:`
    precision mediump float;
  ...
  `},Ue=`I understand the creator of this sick beat Nxnja has a copyright notice on his music distribution website.\r
\r
...
`,We=D(`<div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 animate-pulse svelte-1o4jdf5"><div class="bg-black/75 border border-red-500/30 px-3 py-1.5 rounded text-[10px] font-mono tracking-widest text-red-500 font-bold uppercase shadow-[0_0_15px_rgba(239,68,68,0.25)] select-none svelte-1o4jdf5">NO SIGNAL</div></div>`),Ge=D(`<div class="visualizer-container cursor-pointer svelte-1o4jdf5"><canvas class="visualizer-canvas svelte-1o4jdf5"></canvas> <!> <div class="visualizer-hover-overlay svelte-1o4jdf5"><!></div></div>`),Ke=D(`<div class="visualizer-container bg-[#050508]/40 border border-white/5 flex items-center justify-center svelte-1o4jdf5"><!></div>`),qe=D(`<div class="vinyl-record-clicker cursor-pointer w-full h-full svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div><div class="groove g1 svelte-1o4jdf5"></div> <div class="groove g2 svelte-1o4jdf5"></div> <div class="groove g3 svelte-1o4jdf5"></div> <div class="groove g4 svelte-1o4jdf5"></div> <div class="record-label svelte-1o4jdf5"><img loading="lazy"/></div> <div class="spindle svelte-1o4jdf5"></div></div> <div></div></div>`),Je=D(`<div class="cassette-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="cassette-tape svelte-1o4jdf5"><div class="cassette-label bg-gradient-to-r from-purple-800 to-pink-700 svelte-1o4jdf5"><span class="cassette-track-title svelte-1o4jdf5"> </span> <span class="cassette-brand svelte-1o4jdf5">WEAREDOGS AUDIO</span></div> <div class="cassette-window bg-zinc-950/80 svelte-1o4jdf5"><div></div> <div></div> <div></div> <div></div></div></div></div>`),Ye=D(`<div class="floppy-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="floppy-disk svelte-1o4jdf5"><div class="floppy-corner svelte-1o4jdf5"></div> <div class="floppy-write-protect svelte-1o4jdf5"></div> <div class="floppy-label bg-slate-100 text-slate-900 svelte-1o4jdf5"><div class="floppy-label-stripe bg-red-600 svelte-1o4jdf5"></div> <div class="floppy-label-stripe-blue bg-blue-600 svelte-1o4jdf5"></div> <div class="floppy-label-content svelte-1o4jdf5"><div class="floppy-song truncate font-mono svelte-1o4jdf5"> </div> <div class="floppy-artist truncate font-mono svelte-1o4jdf5"> </div></div></div> <div class="floppy-shutter-door bg-zinc-700 svelte-1o4jdf5"><div></div> <div class="floppy-shutter-opening bg-zinc-950 svelte-1o4jdf5"><div></div></div></div> <div></div></div></div>`),Xe=D(`<div></div>`),Ze=D(`<div class="musicbox-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="music-box svelte-1o4jdf5"><div></div> <div class="music-box-interior border border-amber-900/40 svelte-1o4jdf5"><div class="music-box-gears svelte-1o4jdf5"><div></div> <div></div></div> <div class="music-box-drum-wrap svelte-1o4jdf5"><div><div class="music-box-pins svelte-1o4jdf5"><div class="pin pin-1 svelte-1o4jdf5"></div> <div class="pin pin-2 svelte-1o4jdf5"></div> <div class="pin pin-3 svelte-1o4jdf5"></div> <div class="pin pin-4 svelte-1o4jdf5"></div> <div class="pin pin-5 svelte-1o4jdf5"></div> <div class="pin pin-6 svelte-1o4jdf5"></div></div></div></div> <div class="music-box-comb svelte-1o4jdf5"></div></div></div></div>`),Qe=D(`<span></span>`),$e=D(`<div class="spin-ring svelte-1o4jdf5"></div>`),et=D(`<div class="volume-popover svelte-1o4jdf5"><button class="ctrl ctrl-xs mr-2 border border-white/10 rounded-full p-1 hover:bg-white/10 svelte-1o4jdf5" aria-label="Mute"><!></button> <input type="range" class="vol-slider-pop svelte-1o4jdf5" min="0" max="1" step="0.01" aria-label="Volume"/> <span class="text-[10px] font-bold text-white/60 min-w-[28px] text-right font-mono select-none svelte-1o4jdf5"> </span></div>`),tt=D(`<div class="eq svelte-1o4jdf5"><div class="eq-b svelte-1o4jdf5"></div> <div class="eq-b svelte-1o4jdf5"></div> <div class="eq-b svelte-1o4jdf5"></div></div>`),nt=D(`<span class="svelte-1o4jdf5"></span>`),rt=D(`<span class="text-amber-400 flex items-center gap-1 text-[9px] font-bold tracking-wider uppercase bg-amber-500/10 px-1.5 py-0.5 rounded flex-shrink-0 svelte-1o4jdf5" title="Failed to fetch music source from remote database"><!> Error Fetching</span>`),it=D(`<button class="cursor-pointer svelte-1o4jdf5" style="background: none; border: none; padding: 0; color: inherit; font: inherit;">i</button>`),at=D(`<a target="_blank" class="svelte-1o4jdf5">i</a>`),ot=D(`<span class="inst-chip-link svelte-1o4jdf5"><!></span>`),st=D(`<div><div class="tr-num svelte-1o4jdf5"><!></div> <img loading="lazy" class="tr-art svelte-1o4jdf5"/> <div class="tr-info svelte-1o4jdf5"><div class="flex items-center gap-1.5 min-w-0 svelte-1o4jdf5"><span> </span> <!></div> <span class="tr-meta svelte-1o4jdf5"> </span></div> <div class="flex items-center gap-2 flex-shrink-0 svelte-1o4jdf5"><!>  <button class="tr-share-btn svelte-1o4jdf5" title="Copy track link" aria-label="Share track"><!></button></div></div>`),ct=D(`<div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 animate-pulse svelte-1o4jdf5"><div class="bg-black/75 border border-red-500/30 px-4 py-2 rounded text-[12px] font-mono tracking-widest text-red-500 font-bold uppercase shadow-[0_0_20px_rgba(239,68,68,0.3)] select-none svelte-1o4jdf5">NO SIGNAL</div></div>`),lt=D(`<button> </button>`),ut=D(`<div class="visualizer-container fullscreen cursor-pointer svelte-1o4jdf5"><canvas class="visualizer-canvas svelte-1o4jdf5"></canvas> <!> <div class="visualizer-overlay svelte-1o4jdf5"><div class="flex items-center gap-1 bg-black/60 backdrop-blur-md rounded-lg p-1 border border-white/10 svelte-1o4jdf5"></div></div></div>`),dt=D(`<div class="arigato-modal-backdrop svelte-1o4jdf5"><div class="arigato-modal-content svelte-1o4jdf5"><header class="arigato-modal-header svelte-1o4jdf5"><h2 class="svelte-1o4jdf5">ARIGATO INFO</h2> <button class="arigato-close-btn svelte-1o4jdf5"><!></button></header> <div class="arigato-modal-body scroll-y svelte-1o4jdf5"><div class="merch-link-container svelte-1o4jdf5"><a href="https://nxnjaa.beatstars.com/" target="_blank" rel="noopener noreferrer" class="merch-link-btn svelte-1o4jdf5"><!> NXNJA MERCH & MUSIC</a></div> <p class="intro-text svelte-1o4jdf5"></p> <div class="tos-box svelte-1o4jdf5"><div class="tos-microtext svelte-1o4jdf5"></div></div> <p class="outro-text svelte-1o4jdf5"></p></div></div></div>`),ft=D(`<div class="mp-backdrop svelte-1o4jdf5"><div><header class="panel-header svelte-1o4jdf5"><div class="brand svelte-1o4jdf5"><button class="logo-btn svelte-1o4jdf5" aria-label="Open DOGS Info"><!></button> <h1 class="svelte-1o4jdf5"></h1></div> <button class="close-btn svelte-1o4jdf5" aria-label="Close panel"><!></button></header> <div class="mp-body svelte-1o4jdf5"><div class="songs-layout svelte-1o4jdf5"><div><div><div><!></div>  <div class="track-info mt-2 svelte-1o4jdf5"><div class="flex items-center justify-center mb-1.5 svelte-1o4jdf5"><button class="player-share-btn svelte-1o4jdf5" title="Copy track link" aria-label="Share track"><!></button></div> <div><h2> </h2></div> <div><p> </p></div> <div><p> </p></div></div></div> <div class="player-controls-block svelte-1o4jdf5"><div class="progress-row svelte-1o4jdf5"><span class="ptime svelte-1o4jdf5"> </span> <div class="progress-wrap waveform-slider-wrap relative h-9 flex items-end svelte-1o4jdf5"><div class="waveform-bars flex items-end justify-between absolute inset-0 pointer-events-none px-1 h-full svelte-1o4jdf5"></div> <input type="range" class="seek-input absolute inset-0 opacity-0 cursor-pointer w-full h-full svelte-1o4jdf5" min="0" step="0.1" aria-label="Seek"/></div> <span class="ptime svelte-1o4jdf5"> </span></div> <div class="controls-row svelte-1o4jdf5"><button aria-label="Shuffle"><!></button> <button class="ctrl ctrl-md svelte-1o4jdf5" aria-label="Previous"><!></button> <button><!></button> <button class="ctrl ctrl-md svelte-1o4jdf5" aria-label="Next"><!></button> <button aria-label="Repeat"><!></button></div> <div class="w-full flex flex-col items-center gap-1.5 mt-2 px-1 svelte-1o4jdf5"><div><span><!> <span class="svelte-1o4jdf5">VOCAL</span></span> <div class="dj-fader-slot relative svelte-1o4jdf5"><div></div></div> <span><!> <span class="svelte-1o4jdf5">INST</span></span></div></div> <div class="relative flex justify-center items-center gap-3 mt-2 w-full svelte-1o4jdf5"><!> <div class="flex items-center gap-1.5 svelte-1o4jdf5"><button aria-label="Toggle Visualizer"><!></button> <button> </button></div> <div class="relative svelte-1o4jdf5"><button class="ctrl ctrl-xs vol-toggle-btn svelte-1o4jdf5" aria-label="Toggle volume slider"><!></button></div></div></div></div> <div><div class="mobile-close-bar hidden py-2 px-4 border-b border-white/5 flex items-center justify-between svelte-1o4jdf5"><span class="text-xs font-bold text-white/50 svelte-1o4jdf5">Track Library</span> <button class="px-3 py-1 bg-white/5 text-white/75 rounded-lg text-xs font-bold svelte-1o4jdf5">Back to player</button></div> <div class="tl-header flex justify-between items-center gap-3 svelte-1o4jdf5"><div class="flex items-center gap-2 svelte-1o4jdf5"><!><span class="svelte-1o4jdf5">TRACKS</span> <span class="tl-count svelte-1o4jdf5"> </span></div> <div class="flex items-center gap-1.5 ml-auto svelte-1o4jdf5"><span class="text-[9px] text-white/30 font-bold font-sans svelte-1o4jdf5">SORT BY:</span> <select class="bg-black/40 border border-white/10 rounded px-1.5 py-0.5 text-[10px] font-bold text-white/60 outline-none cursor-pointer hover:border-white/20 transition-all font-sans svelte-1o4jdf5"><option class="svelte-1o4jdf5">DEFAULT</option><option class="svelte-1o4jdf5">ARTIST</option><option class="svelte-1o4jdf5">ALBUM</option><option class="svelte-1o4jdf5">YEAR</option><option class="svelte-1o4jdf5">FILENAME</option><option class="svelte-1o4jdf5">GENRE</option><option class="svelte-1o4jdf5">SEASON</option></select></div></div> <div class="tracklist scroll-y svelte-1o4jdf5"></div></div></div></div> <footer class="mp-footer svelte-1o4jdf5"><div class="mp-status svelte-1o4jdf5"><span class="mp-dot svelte-1o4jdf5"></span><span class="svelte-1o4jdf5">🐕</span></div> <span class="svelte-1o4jdf5">MUSIC</span></footer></div> <!> <canvas class="fader-fx-canvas pointer-events-none svelte-1o4jdf5"></canvas> <!></div>`);function pt(D,j){ee(j,!0);let Me=`/img/error_cover.png`;function pt(e){e.target.src.endsWith(Me)||(e.target.src=Me)}let mt=s(j,`isClosing`,3,!1),ht=s(j,`initialTrackId`,3,null),gt=Re(()=>j.onClose()),F=x(`default`),I=x(!1),_t=x(!1),vt=x(!1),yt=x(null),bt=u(()=>!!P.fetchErrors[P.library[P.currentTrackIndex]?.id]),L=u(()=>P.isPlaying&&!mt()&&!r(bt)),R=x(!1),z=x(0),xt=x(!1),B=x(null),V=null,H=!1,St=x(!1),Ct=x(!1),wt=u(()=>{let e=Ue.split(/`{5,}/);return{intro:e[0]||``,tos:e[1]||``,outro:e[2]||``}});function Tt(e){if(!e)return``;let t=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`);return t=t.replace(/(https?:\/\/[^\s]+)/g,`<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>`),t=t.replace(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9._-]+)/g,`<a href="mailto:$1">$1</a>`),t.replace(/\n/g,`<br>`)}let Et=u(()=>{let e=r(G);if(!e)return Array(60).fill(10);if(P.waveformPeaks[e.id])return P.waveformPeaks[e.id];let t=e.id,n=[],i=0;for(let e=0;e<t.length;e++)i=(i<<5)-i+t.charCodeAt(e),i|=0;let a=Math.abs(i)%1e3;for(let e=0;e<60;e++){let t=e/59,r=Math.sin(a+t*Math.PI*4),i=Math.cos(a*1.5+t*Math.PI*10)*.4,o=Math.sin(a*2.3+t*Math.PI*22)*.15,s=Math.abs(r+i+o)/1.55,c=Math.sin(t*Math.PI),l=(s*70+15)*c;n.push(Math.max(10,Math.round(l)))}return n});t(()=>{window.innerWidth<=640&&r(R)&&r(z)===0&&je(()=>r(I))&&a(I,!1)}),t(()=>{P.isPlaying&&a(St,!0)});let Dt=u(()=>!P.isPlaying&&!r(St)?He.fragmentShader:Ve[r(z)].fragmentShader);t(()=>{let e=P.analyser;return r(R)&&r(B)&&!mt()&&(V=new Be(r(B),e),V.init(r(Dt)),V.start()),()=>{V&&(V.destroy(),V=null)}}),t(()=>{let e=r(Dt);V&&r(R)&&(V.setPreset(e),V.start())}),t(()=>{r(I)?!history.state?.tracklistOpen&&!H&&(history.pushState({tracklistOpen:!0},``),H=!0):H&&(history.back(),H=!1)}),be(()=>{H&&(history.back(),H=!1)});function Ot(e){!e.state?.tracklistOpen&&r(I)&&(a(I,!1),H=!1)}function kt(e){r(vt)&&r(yt)&&!r(yt).contains(e.target)&&!e.target.closest(`.vol-toggle-btn`)&&a(vt,!1)}let U=u(()=>Fe.unlocked?Ie:Ie.filter(e=>e.public!==!1));function At(e){return e.src?e.src.split(`/`).pop():``}function jt(e){if(!e.dateAdded)return`Summer`;let t=new Date(e.dateAdded).getMonth();return t===11||t===0||t===1?`Winter`:t>=2&&t<=4?`Spring`:t>=5&&t<=7?`Summer`:`Fall`}let W=u(()=>{let e=[...r(U)];return r(F)===`artist`?e.sort((e,t)=>e.artist.localeCompare(t.artist)):r(F)===`album`?e.sort((e,t)=>e.album.localeCompare(t.album)):r(F)===`year`?e.sort((e,t)=>(e.year||0)-(t.year||0)):r(F)===`filename`?e.sort((e,t)=>At(e).localeCompare(At(t))):r(F)===`genre`?e.sort((e,t)=>(e.genre||``).localeCompare(t.genre||``)):r(F)===`season`&&e.sort((e,t)=>jt(e).localeCompare(jt(t))),e}),G=u(()=>r(U)[P.currentTrackIndex]??r(U)[0]);t(()=>{let e=r(U);if(P.library===e||P.library.length===0)return;let t=P.library[P.currentTrackIndex]?.id;P.init(e);let n=e.findIndex(e=>e.id===t);n===-1?(P.pause(),P.loadTrack(0,!1)):P.currentTrackIndex=n});let Mt=x(0),Nt=x(0),Pt=x(0),Ft=x(0),It=x(0),Lt=x(0),Rt=x(null),zt=null;function Bt(e,t){e.stopPropagation();let n=`${window.location.origin}/music/${t.id}`;navigator.clipboard.writeText(n).then(()=>{a(Rt,t.id,!0),zt&&clearTimeout(zt),zt=setTimeout(()=>{a(Rt,null)},2e3)}).catch(e=>{console.error(`Failed to copy share link:`,e)})}be(()=>{zt&&clearTimeout(zt)}),Ae(()=>{if(Fe.revalidate(),P.init(r(U)),ht()){let e=r(U).findIndex(e=>e.id===ht());e!==-1&&P.loadTrack(e,!0)}else if(!P.hasPickedRandomTrack){P.hasPickedRandomTrack=!0;let e=Math.floor(Math.random()*r(U).length);P.loadTrack(e,!1)}});let K=x(null);function Vt(){let e=document.querySelector(`.track-row[data-track-id="${r(K)}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Ht(e){a(K,e.id,!0);let t=r(U).findIndex(t=>t.id===e.id);P.currentTrackIndex===t&&!P.fetchErrors[e.id]?P.togglePlay():P.loadTrack(t,!0)}function Ut(){window.innerWidth<=640?a(I,!0):a(R,!r(R))}function Wt(e){window.innerWidth>640||e.target.closest(`.scroll-container`)&&a(I,!0)}function Gt(){let e=!P.isInstrumental;P.setCrossfade(e)||(oe(J),r(Jt)||(a(Jt,!0),setTimeout(()=>{a(Jt,!1)},300)),r(J)===5?(an(),a(Yt,!0),setTimeout(()=>{a(Yt,!1)},150)):r(J)===10?an(35):r(J)>5&&r(J)<10?an(8):r(J)>10&&Math.random()<.4&&an(3))}function Kt(e){return!e||isNaN(e)?`0:00`:`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function qt(e){let t=document.activeElement;if(!(t&&(t.tagName===`INPUT`||t.tagName===`TEXTAREA`||t.isContentEditable))){if(e.code===`Space`||e.key===` `)e.preventDefault(),P.togglePlay();else if(e.key===`ArrowDown`){if(r(W).length>0){e.preventDefault();let t=r(W).findIndex(e=>e.id===r(K));if(t===-1){let e=r(U)[P.currentTrackIndex];t=r(W).findIndex(t=>t.id===e?.id)}let n=(t+1)%r(W).length;a(K,r(W)[n].id,!0),Vt()}}else if(e.key===`ArrowUp`){if(r(W).length>0){e.preventDefault();let t=r(W).findIndex(e=>e.id===r(K));if(t===-1){let e=r(U)[P.currentTrackIndex];t=r(W).findIndex(t=>t.id===e?.id)}let n=(t-1+r(W).length)%r(W).length;a(K,r(W)[n].id,!0),Vt()}}else if(e.key===`Enter`&&r(K)){e.preventDefault();let t=r(W).find(e=>e.id===r(K));t&&Ht(t)}}}let q=x(null),J=x(0),Jt=x(!1),Yt=x(!1),Y,X,Z,Q=[],$=[],Xt,Zt=x(!1);t(()=>(r(q)&&en(),()=>{Xt&&cancelAnimationFrame(Xt),window.removeEventListener(`resize`,tn),window.visualViewport?.removeEventListener(`resize`,tn),Z&&(Z.dispose(),Z=null),Y=null,X=null,Q=[],$=[]})),t(()=>{if(P.currentTrackIndex,mt(),a(J,0),a(Zt,!1),Y){for(let e of Q)Y.remove(e.mesh);for(let e of $)Y.remove(e.mesh)}Q=[],$=[]});function Qt(){if(!r(q))return{width:window.innerWidth,height:window.innerHeight};let e=r(q).getBoundingClientRect();return{width:e.width||window.innerWidth,height:e.height||window.innerHeight}}function $t(){let{width:e,height:t}=Qt(),n=document.querySelector(`.dj-fader-knob`);if(!n)return{x:e/2,y:t/2};let i=r(q)?r(q).getBoundingClientRect():{left:0,top:0},a=n.getBoundingClientRect();return{x:a.left+a.width/2-i.left,y:t-(a.top+a.height/2-i.top)}}function en(){if(!r(q))return;let{width:e,height:t}=Qt();r(q).width=e,r(q).height=t,Y=new ae,X=new d(0,e,t,0,-1,1),Z=new de({canvas:r(q),alpha:!0,antialias:!0}),Z.setSize(e,t,!1),Z.setPixelRatio(Math.min(window.devicePixelRatio,2)),window.addEventListener(`resize`,tn),window.visualViewport?.addEventListener(`resize`,tn),nn()}function tn(){if(!r(q)||!Z||!X)return;let{width:e,height:t}=Qt();r(q).width=e,r(q).height=t,Z.setSize(e,t,!1),X.right=e,X.top=t,X.updateProjectionMatrix()}function nn(){if(Xt=requestAnimationFrame(nn),!(!Y||!X||!Z||!r(q))){if(r(J)>=10&&(a(Zt,!0),Math.random()<.22)){let e=$t();rn(e.x,e.y)}for(let e=Q.length-1;e>=0;e--){let t=Q[e];t.x+=t.vx,t.y+=t.vy,t.vy+=t.ay,t.life-=t.decay,t.mesh.position.set(t.x,t.y,0),t.mesh.material.opacity=t.life,t.life<=0&&(Y.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),Q.splice(e,1))}for(let e=$.length-1;e>=0;e--){let t=$[e];t.x+=t.vx,t.y+=t.vy,t.life-=t.decay;let n=t.startScale+(1-t.life)*88;t.mesh.scale.set(n,n,1),t.mesh.position.set(t.x,t.y,0),t.mesh.material.opacity=t.life*.16,t.life<=0&&(Y.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),$.splice(e,1))}Z.render(Y,X)}}function rn(e,t){if(!Y)return;let r=new ne(5,8),i=.85+Math.random()*.12,a=new ve(r,new p({color:new n(i,i,i*1.01),transparent:!0,opacity:.06,blending:1}));a.position.set(e,t,0),Y.add(a),$.push({mesh:a,x:e,y:t,vx:(Math.random()-.5)*.55+Math.sin(Date.now()*.001)*.22,vy:Math.random()*.7+1.25,startScale:1,life:1,decay:6e-4+Math.random()*4e-4})}function an(e=25){if(!Y||!r(q))return;let t=$t(),i=t.x,a=t.y;for(let t=0;t<e;t++){let e=new ve(new ne(1.3,4),new p({color:new n(Math.random()<.4?16711765:16755200),transparent:!0,opacity:1,blending:2}));e.position.set(i,a,0),Y.add(e);let t=Math.random()*Math.PI*2,r=Math.random()*4+2;Q.push({mesh:e,x:i,y:a,vx:Math.cos(t)*r,vy:Math.sin(t)*r,ay:-.15,life:1,decay:.02+Math.random()*.02})}}var on=ft();M(`keydown`,i,qt),M(`popstate`,i,Ot),M(`click`,i,kt);var sn=o(on);let cn;var ln=o(sn),un=o(ln),dn=o(un);Le(o(dn),{size:`panel`}),E(dn);var fn=y(dn,2);fn.textContent=`MUSIC`,E(un);var pn=y(un,2);m(o(pn),{size:20}),E(pn),E(ln);var mn=y(ln,2),hn=o(mn),gn=o(hn);let _n;var vn=o(gn);let yn;var bn=o(vn);let xn;var Sn=o(bn),Cn=e=>{var t=Ge(),n=o(t);b(n,e=>a(B,e),()=>r(B));var i=y(n,2),s=e=>{k(e,We())};T(i,e=>{!P.isPlaying&&!r(St)&&e(s)});var c=y(i,2);Ee(o(c),{size:16,class:`text-white/70`}),E(c),E(t),w(`click`,t,()=>{a(xt,!0)}),k(e,t)},wn=e=>{var t=Ke();Ee(o(t),{size:16,class:`text-white/20`}),E(t),k(e,t)},Tn=t=>{var n=he(),i=f(n),s=t=>{var n=qe(),i=o(n);let s;var c=y(o(i),8),l=o(c);let u;E(c),e(2),E(i);var d=y(i,2);let f;E(n),O(()=>{s=v(i,1,`vinyl-record svelte-1o4jdf5`,null,s,{spinning:r(L)}),S(l,`src`,P.fetchErrors[r(G).id]||!r(G).cover?Me:r(G).cover),S(l,`alt`,r(G).album),u=v(l,1,`record-art svelte-1o4jdf5`,null,u,{loaded:r(_t)}),f=v(d,1,`tonearm svelte-1o4jdf5`,null,f,{playing:r(L)})}),w(`click`,n,Ut),M(`load`,l,()=>a(_t,!0)),M(`error`,l,pt),re(l),k(t,n)},c=t=>{let n=u(()=>P.duration>0?(1-P.currentTime/P.duration)*.45+.25:.48),i=u(()=>P.duration>0?P.currentTime/P.duration*.45+.25:.48);var a=Je(),s=o(a),c=o(s),l=o(c),d=o(l,!0);E(l),e(2),E(c);var f=y(c,2),p=o(f);let m;var h=y(p,2);let g;var _=y(h,2);let ee;var b=y(_,2);let te;E(f),E(s),E(a),O(()=>{A(d,r(G).title),m=v(p,1,`spindle-left bg-zinc-900 svelte-1o4jdf5`,null,m,{spinning:r(L)}),g=v(h,1,`tape-roll-left bg-amber-950/70 svelte-1o4jdf5`,null,g,{spinning:r(L)}),C(h,`width: ${r(n)*46}px; height: ${r(n)*46}px;`),ee=v(_,1,`spindle-right bg-zinc-900 svelte-1o4jdf5`,null,ee,{spinning:r(L)}),te=v(b,1,`tape-roll-right bg-amber-950/70 svelte-1o4jdf5`,null,te,{spinning:r(L)}),C(b,`width: ${r(i)*46}px; height: ${r(i)*46}px;`)}),w(`click`,a,Ut),k(t,a)},l=e=>{var t=Ye(),n=o(t),i=y(o(n),4),a=y(o(i),4),s=o(a),c=o(s,!0);E(s);var l=y(s,2),u=o(l,!0);E(l),E(a),E(i);var d=y(i,2),f=o(d);let p;var m=y(f,2),h=o(m);let g;E(m),E(d);var _=y(d,2);let ee;E(n),E(t),O(()=>{A(c,r(G).title),A(u,r(G).artist||`WEAREDOGS`),p=v(f,1,`floppy-shutter-slider bg-zinc-400 svelte-1o4jdf5`,null,p,{open:r(L)}),g=v(h,1,`floppy-magnetic-disc bg-zinc-900 svelte-1o4jdf5`,null,g,{spinning:r(L)}),ee=v(_,1,`floppy-drive-led svelte-1o4jdf5`,null,ee,{active:r(L)})}),w(`click`,t,Ut),k(e,t)},d=e=>{var t=Ze(),n=o(t),i=o(n);let a;var s=y(i,2),c=o(s),l=o(c);let u;var d=y(l,2);let f;E(c);var p=y(c,2),m=o(p);let h;E(p);var g=y(p,2);pe(g,20,()=>Array(10),Te,(e,t,n)=>{var i=Xe();let a;O(e=>a=v(i,1,`comb-tooth svelte-1o4jdf5`,null,a,e),[()=>({vibrating:r(L)&&n%3==Math.floor(P.currentTime*4)%3})]),k(e,i)}),E(g),E(s),E(n),E(t),O(()=>{a=v(i,1,`music-box-key svelte-1o4jdf5`,null,a,{spinning:r(L)}),u=v(l,1,`music-box-gear gear-1 svelte-1o4jdf5`,null,u,{spinning:r(L)}),f=v(d,1,`music-box-gear gear-2 svelte-1o4jdf5`,null,f,{spinning:r(L)}),h=v(m,1,`music-box-drum bg-gradient-to-r from-amber-600 via-amber-500 to-amber-700 svelte-1o4jdf5`,null,h,{spinning:r(L)})}),w(`click`,t,Ut),k(e,t)};T(i,e=>{ze.musicDeckModel===`vinyl`?e(s):ze.musicDeckModel===`cassette`?e(c,1):ze.musicDeckModel===`floppy`?e(l,2):ze.musicDeckModel===`musicbox`&&e(d,3)}),k(t,n)};T(Sn,e=>{r(R)&&!r(xt)?e(Cn):r(R)&&r(xt)?e(wn,1):e(Tn,-1)}),E(bn);var En=y(bn,2),Dn=o(En),On=o(Dn),kn=o(On),An=e=>{fe(e,{size:12,class:`text-[#22c55e]`})},jn=e=>{te(e,{size:12})};T(kn,e=>{r(Rt)===r(G).id?e(An):e(jn,-1)}),E(On),E(Dn);var Mn=y(Dn,2);let Nn;var Pn=o(Mn);let Fn;var In=o(Pn,!0);E(Pn),E(Mn);var Ln=y(Mn,2);let Rn;var zn=o(Ln);let Bn;var Vn=o(zn,!0);E(zn),E(Ln);var Hn=y(Ln,2);let Un;var Wn=o(Hn);let Gn;var Kn=o(Wn,!0);E(Wn),E(Hn),E(En),E(vn);var qn=y(vn,2),Jn=o(qn),Yn=o(Jn),Xn=o(Yn,!0);E(Yn);var Zn=y(Yn,2),Qn=o(Zn);pe(Qn,21,()=>r(Et),Te,(e,t,n)=>{let i=u(()=>P.duration>0?P.currentTime/P.duration:0),a=u(()=>n/60);var o=Qe();let s;O(()=>{s=v(o,1,`waveform-bar transition-colors duration-100 rounded-full svelte-1o4jdf5`,null,s,{active:r(a)<=r(i)}),C(o,`height: ${r(t)??``}%; width: 3px;`)}),k(e,o)}),E(Qn);var $n=y(Qn,2);ie($n),E(Zn);var er=y(Zn,2),tr=o(er,!0);E(er),E(Jn);var nr=y(Jn,2),rr=o(nr);let ir;g(o(rr),{size:15}),E(rr);var ar=y(rr,2);h(o(ar),{size:19}),E(ar);var or=y(ar,2);let sr;var cr=o(or),lr=e=>{Pe(e,{size:22})},ur=e=>{k(e,$e())},dr=e=>{Oe(e,{size:22,fill:`currentColor`})},fr=e=>{ke(e,{size:22,fill:`currentColor`})};T(cr,e=>{P.fetchErrors[r(G).id]?e(lr):P.isLoading?e(ur,1):P.isPlaying?e(dr,2):e(fr,-1)}),E(or);var pr=y(or,2);ye(o(pr),{size:19}),E(pr);var mr=y(pr,2);let hr;var gr=o(mr),_r=e=>{le(e,{size:15})},vr=e=>{Ce(e,{size:15})},yr=e=>{l(e,{size:15})};T(gr,e=>{P.repeatMode===2?e(_r):P.repeatMode===3?e(vr,1):e(yr,-1)}),E(mr),E(nr);var br=y(nr,2),xr=o(br);let Sr;var Cr=o(xr);let wr;xe(o(Cr),{size:12}),e(2),E(Cr);var Tr=y(Cr,2),Er=o(Tr);let Dr;E(Tr);var Or=y(Tr,2);let kr;_(o(Or),{size:12}),e(2),E(Or),E(xr),E(br);var Ar=y(br,2),jr=o(Ar),Mr=e=>{var t=et(),n=o(t),i=o(n),s=e=>{_e(e,{size:12,class:`text-red-400`})},c=e=>{me(e,{size:12})};T(i,e=>{P.isMuted||P.volume===0?e(s):e(c,-1)}),E(n);var l=y(n,2);ie(l);var u=y(l,2),d=o(u);E(u),E(t),b(t,e=>a(yt,e),()=>r(yt)),O(e=>{De(l,P.volume),A(d,`${e??``}%`)},[()=>Math.round(P.volume*100)]),w(`click`,n,()=>P.toggleMute()),w(`input`,l,e=>P.setVolume(parseFloat(e.target.value))),k(e,t)};T(jr,e=>{r(vt)&&e(Mr)});var Nr=y(jr,2),Pr=o(Nr);let Fr;we(o(Pr),{size:13}),E(Pr);var Ir=y(Pr,2),Lr=o(Ir,!0);E(Ir),E(Nr);var Rr=y(Nr,2),zr=o(Rr),Br=o(zr),Vr=e=>{_e(e,{size:13,class:`text-red-400`})},Hr=e=>{me(e,{size:13})};T(Br,e=>{P.isMuted||P.volume===0?e(Vr):e(Hr,-1)}),E(zr),E(Rr),E(Ar),E(qn),E(gn);var Ur=y(gn,2);let Wr;var Gr=o(Ur),Kr=y(o(Gr),2);E(Gr);var qr=y(Gr,2),Jr=o(qr),Yr=o(Jr);Ne(Yr,{size:13});var Xr=y(Yr,3),Zr=o(Xr,!0);E(Xr),E(Jr);var Qr=y(Jr,2),$r=y(o(Qr),2),ei=o($r);ei.value=ei.__value=`default`;var ti=y(ei);ti.value=ti.__value=`artist`;var ni=y(ti);ni.value=ni.__value=`album`;var ri=y(ni);ri.value=ri.__value=`year`;var ii=y(ri);ii.value=ii.__value=`filename`;var ai=y(ii);ai.value=ai.__value=`genre`;var oi=y(ai);oi.value=oi.__value=`season`,E($r),E(Qr),E(qr);var si=y(qr,2);pe(si,21,()=>r(W),Te,(t,n,i)=>{var s=st();let c;var l=o(s),u=o(l),d=e=>{k(e,tt())},f=e=>{var t=nt();t.textContent=i+1,k(e,t)};T(u,e=>{r(G).id===r(n).id&&P.isPlaying?e(d):e(f,-1)}),E(l);var p=y(l,2),m=y(p,2),h=o(m),g=o(h);let _;var ee=o(g,!0);E(g);var b=y(g,2),ne=t=>{var n=rt();Pe(o(n),{size:10}),e(),E(n),k(t,n)};T(b,e=>{P.fetchErrors[r(n).id]&&e(ne)}),E(h);var x=y(h,2),ie=o(x);E(x),E(m);var ae=y(m,2),oe=o(ae),se=e=>{var t=ot(),i=o(t),s=e=>{var t=it();w(`click`,t,e=>{e.stopPropagation(),a(Ct,!0)}),k(e,t)},c=e=>{var t=at();O(()=>S(t,`href`,r(n).attrib)),w(`click`,t,e=>e.stopPropagation()),k(e,t)};T(i,e=>{r(n).id===`arigato`?e(s):e(c,-1)}),E(t),k(e,t)};T(oe,e=>{r(n).attrib&&e(se)});var ce=y(oe,2),le=o(ce),ue=e=>{fe(e,{size:12,class:`text-[#22c55e]`})},C=e=>{te(e,{size:12})};T(le,e=>{r(Rt)===r(n).id?e(ue):e(C,-1)}),E(ce),E(ae),E(s),O(()=>{c=v(s,1,`track-row svelte-1o4jdf5`,null,c,{active:r(G).id===r(n).id,"kb-focused":r(K)===r(n).id,"fetch-error":P.fetchErrors[r(n).id]}),S(s,`data-track-id`,r(n).id),S(p,`src`,P.fetchErrors[r(n).id]||!r(n).cover?Me:r(n).cover),S(p,`alt`,r(n).album),_=v(g,1,`tr-title svelte-1o4jdf5`,null,_,{"line-through":P.fetchErrors[r(n).id],"opacity-50":P.fetchErrors[r(n).id]}),A(ee,r(n).title),A(ie,`${r(n).artist??``} · ${r(n).album??``} (${(r(n).year||``)??``})`)}),w(`click`,s,()=>Ht(r(n))),M(`error`,p,pt),re(p),w(`click`,ce,e=>Bt(e,r(n))),k(t,s)}),E(si),E(Ur),E(hn),E(mn),e(2),E(sn);var ci=y(sn,2),li=e=>{var t=ut(),n=o(t);b(n,e=>a(B,e),()=>r(B));var i=y(n,2),s=e=>{k(e,ct())};T(i,e=>{!P.isPlaying&&!r(St)&&e(s)});var c=y(i,2),l=o(c);pe(l,21,()=>Ve,Te,(e,t,n)=>{var i=lt(),s=o(i,!0);E(i),O(()=>{v(i,1,`px-2 py-1 rounded text-[9px] font-bold transition-all uppercase tracking-wider font-mono
                ${r(z)===n?`bg-purple-600 text-white`:`text-white/40 hover:text-white/80`}`,`svelte-1o4jdf5`),A(s,r(t).name)}),w(`click`,i,()=>a(z,n,!0)),k(e,i)}),E(l),E(c),E(t),w(`click`,t,e=>{e.stopPropagation(),a(xt,!1)}),w(`click`,c,e=>e.stopPropagation()),k(e,t)};T(ci,e=>{r(R)&&r(xt)&&e(li)});var ui=y(ci,2);b(ui,e=>a(q,e),()=>r(q));var di=y(ui,2),fi=t=>{var n=dt(),i=o(n),s=o(i),c=y(o(s),2);m(o(c),{size:16}),E(c),E(s);var l=y(s,2),u=o(l),d=o(u);ce(o(d),{size:14}),e(),E(d),E(u);var f=y(u,2);ge(f,()=>Tt(r(wt).intro),!0),E(f);var p=y(f,2),h=o(p);ge(h,()=>Tt(r(wt).tos),!0),E(h),E(p);var g=y(p,2);ge(g,()=>Tt(r(wt).outro),!0),E(g),E(l),E(i),E(n),w(`click`,n,()=>a(Ct,!1)),w(`click`,i,e=>e.stopPropagation()),w(`click`,c,()=>a(Ct,!1)),Se(3,n,()=>se,()=>({duration:150})),k(t,n)};T(di,e=>{r(Ct)&&e(fi)}),E(on),O((e,t)=>{cn=v(sn,1,`mp-container svelte-1o4jdf5`,null,cn,{closing:mt(),"theme-inst":P.isInstrumental}),_n=v(gn,1,`player-side svelte-1o4jdf5`,null,_n,{"tracklist-open":r(I)}),yn=v(vn,1,`player-top-block transition-all duration-300 ease-in-out svelte-1o4jdf5`,null,yn,{"opacity-0":r(I),"scale-95":r(I),"pointer-events-none":r(I)}),xn=v(bn,1,`vinyl-wrapper relative overflow-hidden svelte-1o4jdf5`,null,xn,{"deck-glitch":r(bt)}),Nn=v(Mn,1,`scroll-container svelte-1o4jdf5`,null,Nn,{overflowing:r(Nt)>r(Mt)}),C(Mn,`--scroll-dist: -${r(Nt)-r(Mt)}px`),Fn=v(Pn,1,`track-title scroll-text svelte-1o4jdf5`,null,Fn,{"animate-scroll":r(Nt)>r(Mt)}),A(In,r(G).title),Rn=v(Ln,1,`scroll-container svelte-1o4jdf5`,null,Rn,{overflowing:r(Ft)>r(Pt)}),C(Ln,`--scroll-dist: -${r(Ft)-r(Pt)}px`),Bn=v(zn,1,`track-artist scroll-text svelte-1o4jdf5`,null,Bn,{"animate-scroll":r(Ft)>r(Pt)}),A(Vn,r(G).artist),Un=v(Hn,1,`scroll-container svelte-1o4jdf5`,null,Un,{overflowing:r(Lt)>r(It)}),C(Hn,`--scroll-dist: -${r(Lt)-r(It)}px`),Gn=v(Wn,1,`track-album scroll-text svelte-1o4jdf5`,null,Gn,{"animate-scroll":r(Lt)>r(It)}),A(Kn,r(G).album),A(Xn,e),S($n,`max`,P.duration||100),De($n,P.currentTime),A(tr,t),ir=v(rr,1,`ctrl ctrl-sm svelte-1o4jdf5`,null,ir,{"active-ctrl":P.isShuffled}),sr=v(or,1,`ctrl ctrl-play svelte-1o4jdf5`,null,sr,{"ctrl-error":P.fetchErrors[r(G).id]}),S(or,`aria-label`,P.isPlaying?`Pause`:`Play`),hr=v(mr,1,`ctrl ctrl-sm svelte-1o4jdf5`,null,hr,{"active-ctrl":P.repeatMode>0}),S(mr,`title`,P.repeatMode===1?`Repeat: all`:P.repeatMode===2?`Repeat: one`:P.repeatMode===3?`Stop after current track`:`Repeat: off`),Sr=v(xr,1,`dj-crossfader svelte-1o4jdf5`,null,Sr,{"fader-flash":r(Yt),"fader-fried":r(J)>=10}),wr=v(Cr,1,`fader-label left-label flex items-center gap-1 svelte-1o4jdf5`,null,wr,{active:!P.isInstrumental}),Dr=v(Er,1,`dj-fader-knob svelte-1o4jdf5`,null,Dr,{right:P.isInstrumental,"knob-jiggle":r(Jt),fried:r(J)>=10}),kr=v(Or,1,`fader-label right-label flex items-center gap-1 svelte-1o4jdf5`,null,kr,{active:P.isInstrumental}),Fr=v(Pr,1,`ctrl ctrl-xs svelte-1o4jdf5`,null,Fr,{"active-ctrl":r(R)}),v(Ir,1,`w-[90px] h-[20px] flex items-center justify-center rounded text-[9px] font-bold transition-all font-mono uppercase tracking-wider select-none cursor-pointer
                      ${r(R)?`bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 hover:border-white/25 active:scale-95`:`bg-transparent border border-white/5 text-white/20 hover:text-white/40 hover:border-white/10`}`,`svelte-1o4jdf5`),S(Ir,`title`,r(R)?`Click to cycle presets`:`Click to enable visualizer`),A(Lr,Ve[r(z)].name),Wr=v(Ur,1,`tracklist-side svelte-1o4jdf5`,null,Wr,{"show-mobile":r(I)}),A(Zr,r(U).length)},[()=>Kt(P.currentTime),()=>Kt(P.duration)]),w(`click`,on,gt),w(`click`,sn,e=>e.stopPropagation()),w(`click`,dn,()=>{P.isPlaying||window.dispatchEvent(new CustomEvent(`open-info-panel`))}),w(`click`,pn,function(...e){j.onClose?.apply(this,e)}),w(`click`,En,Wt),w(`click`,On,e=>Bt(e,r(G))),N(Pn,`clientWidth`,e=>a(Nt,e)),N(Mn,`clientWidth`,e=>a(Mt,e)),N(zn,`clientWidth`,e=>a(Ft,e)),N(Ln,`clientWidth`,e=>a(Pt,e)),N(Wn,`clientWidth`,e=>a(Lt,e)),N(Hn,`clientWidth`,e=>a(It,e)),w(`input`,$n,e=>{P.seek(parseFloat(e.target.value))}),w(`change`,$n,e=>{P.isPlaying||P.play(parseFloat(e.target.value))}),w(`click`,rr,()=>P.setShuffle(!P.isShuffled)),w(`click`,ar,()=>P.prevTrack()),w(`click`,or,()=>P.togglePlay()),w(`click`,pr,()=>P.nextTrack()),w(`click`,mr,()=>{P.repeatMode=(P.repeatMode+1)%4}),w(`click`,xr,Gt),w(`click`,Pr,()=>{a(R,!r(R))}),w(`click`,Ir,()=>{r(R)?a(z,(r(z)+1)%Ve.length):a(R,!0)}),w(`click`,zr,()=>{a(vt,!r(vt))}),w(`click`,Kr,()=>{a(I,!1)}),c($r,()=>r(F),e=>a(F,e)),Se(1,hn,()=>se,()=>({duration:120,delay:120})),Se(2,hn,()=>se,()=>({duration:120})),k(D,on),ue()}Me([`click`,`input`,`change`]);export{pt as default};