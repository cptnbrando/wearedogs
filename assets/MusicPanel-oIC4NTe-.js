import{$i as e,At as t,C as n,Fi as r,Fr as i,Gi as a,Hi as o,Hr as s,Ii as c,Jt as l,Kr as u,L as d,Li as f,Lr as p,Lt as m,M as h,Mt as g,Nn as _,Oi as v,Pi as y,Qi as b,Rr as x,S as ee,Si as S,Ui as te,Ur as C,V as ne,Vi as w,X as re,Xi as ie,Xr as T,Yn as ae,Zi as oe,Zr as E,_ as se,ai as ce,at as le,bi as D,ci as ue,cn as de,ea as O,en as fe,fi as k,fn as pe,gr as me,hi as A,ii as he,it as ge,j as _e,jr as ve,jt as ye,ki as j,li as be,mi as xe,nn as Se,nt as Ce,pi as M,qr as we,qt as Te,ri as Ee,si as N,ti as De,tr as Oe,vi as ke,vn as Ae,vt as je,xi as Me,yi as P}from"./vendor-SxXT4ql_.js";import{n as Ne,r as Pe,t as F}from"./AudioCore.svelte-CMbEFHRd.js";import{t as Fe}from"./DogsLogo-B9ee-g3d.js";import{t as Ie}from"./settingsManager.svelte-Da6OvONg.js";var Le=class{constructor(e,t){O(this,`canvas`,null),O(this,`gl`,null),O(this,`analyser`,null),O(this,`program`,null),O(this,`animationFrameId`,null),O(this,`startTime`,0),O(this,`vertexBuffer`,null),O(this,`audioTexture`,null),O(this,`uniforms`,{}),O(this,`frequencyBuffer`,null),this.canvas=e,this.analyser=t,this.frequencyBuffer=new Uint8Array(t?t.frequencyBinCount:128),this.gl=e.getContext(`webgl`)||e.getContext(`experimental-webgl`),this.gl||console.error(`WebGL not supported by this browser.`)}init(e){if(!this.gl)return;let t=this.gl;this.cleanupProgram();let n=this.compileShader(t.VERTEX_SHADER,`
...
`,Ve=A(`<div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 animate-pulse svelte-1o4jdf5"><div class="bg-black/75 border border-red-500/30 px-3 py-1.5 rounded text-[10px] font-mono tracking-widest text-red-500 font-bold uppercase shadow-[0_0_15px_rgba(239,68,68,0.25)] select-none svelte-1o4jdf5">NO SIGNAL</div></div>`),He=A(`<div class="visualizer-container cursor-pointer svelte-1o4jdf5"><canvas class="visualizer-canvas svelte-1o4jdf5"></canvas> <!> <div class="visualizer-hover-overlay svelte-1o4jdf5"><!></div></div>`),Ue=A(`<div class="visualizer-container bg-[#050508]/40 border border-white/5 flex items-center justify-center svelte-1o4jdf5"><!></div>`),We=A(`<div class="vinyl-record-clicker cursor-pointer w-full h-full svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div><div class="groove g1 svelte-1o4jdf5"></div> <div class="groove g2 svelte-1o4jdf5"></div> <div class="groove g3 svelte-1o4jdf5"></div> <div class="groove g4 svelte-1o4jdf5"></div> <div class="record-label svelte-1o4jdf5"><img loading="lazy"/></div> <div class="spindle svelte-1o4jdf5"></div></div> <div></div></div>`),Ge=A(`<div class="cassette-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="cassette-tape svelte-1o4jdf5"><div class="cassette-label bg-gradient-to-r from-purple-800 to-pink-700 svelte-1o4jdf5"><span class="cassette-track-title svelte-1o4jdf5"> </span> <span class="cassette-brand svelte-1o4jdf5">WEAREDOGS AUDIO</span></div> <div class="cassette-window bg-zinc-950/80 svelte-1o4jdf5"><div></div> <div></div> <div></div> <div></div></div></div></div>`),Ke=A(`<div class="floppy-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="floppy-disk svelte-1o4jdf5"><div class="floppy-corner svelte-1o4jdf5"></div> <div class="floppy-write-protect svelte-1o4jdf5"></div> <div class="floppy-label bg-slate-100 text-slate-900 svelte-1o4jdf5"><div class="floppy-label-stripe bg-red-600 svelte-1o4jdf5"></div> <div class="floppy-label-stripe-blue bg-blue-600 svelte-1o4jdf5"></div> <div class="floppy-label-content svelte-1o4jdf5"><div class="floppy-song truncate font-mono svelte-1o4jdf5"> </div> <div class="floppy-artist truncate font-mono svelte-1o4jdf5"> </div></div></div> <div class="floppy-shutter-door bg-zinc-700 svelte-1o4jdf5"><div></div> <div class="floppy-shutter-opening bg-zinc-950 svelte-1o4jdf5"><div></div></div></div> <div></div></div></div>`),qe=A(`<div></div>`),Je=A(`<div class="musicbox-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="music-box svelte-1o4jdf5"><div></div> <div class="music-box-interior border border-amber-900/40 svelte-1o4jdf5"><div class="music-box-gears svelte-1o4jdf5"><div></div> <div></div></div> <div class="music-box-drum-wrap svelte-1o4jdf5"><div><div class="music-box-pins svelte-1o4jdf5"><div class="pin pin-1 svelte-1o4jdf5"></div> <div class="pin pin-2 svelte-1o4jdf5"></div> <div class="pin pin-3 svelte-1o4jdf5"></div> <div class="pin pin-4 svelte-1o4jdf5"></div> <div class="pin pin-5 svelte-1o4jdf5"></div> <div class="pin pin-6 svelte-1o4jdf5"></div></div></div></div> <div class="music-box-comb svelte-1o4jdf5"></div></div></div></div>`),Ye=A(`<span></span>`),Xe=A(`<div class="spin-ring svelte-1o4jdf5"></div>`),Ze=A(`<div class="volume-popover svelte-1o4jdf5"><button class="ctrl ctrl-xs mr-2 border border-white/10 rounded-full p-1 hover:bg-white/10 svelte-1o4jdf5" aria-label="Mute"><!></button> <input type="range" class="vol-slider-pop svelte-1o4jdf5" min="0" max="1" step="0.01" aria-label="Volume"/> <span class="text-[10px] font-bold text-white/60 min-w-[28px] text-right font-mono select-none svelte-1o4jdf5"> </span></div>`),Qe=A(`<div class="eq svelte-1o4jdf5"><div class="eq-b svelte-1o4jdf5"></div> <div class="eq-b svelte-1o4jdf5"></div> <div class="eq-b svelte-1o4jdf5"></div></div>`),$e=A(`<span class="svelte-1o4jdf5"></span>`),et=A(`<span class="text-amber-400 flex items-center gap-1 text-[9px] font-bold tracking-wider uppercase bg-amber-500/10 px-1.5 py-0.5 rounded flex-shrink-0 svelte-1o4jdf5" title="Failed to fetch music source from remote database"><!> Error Fetching</span>`),tt=A(`<button class="cursor-pointer svelte-1o4jdf5" style="background: none; border: none; padding: 0; color: inherit; font: inherit;">i</button>`),nt=A(`<a target="_blank" class="svelte-1o4jdf5">i</a>`),rt=A(`<span class="inst-chip-link svelte-1o4jdf5"><!></span>`),it=A(`<div><div class="tr-num svelte-1o4jdf5"><!></div> <img loading="lazy" class="tr-art svelte-1o4jdf5"/> <div class="tr-info svelte-1o4jdf5"><div class="flex items-center gap-1.5 min-w-0 svelte-1o4jdf5"><span> </span> <!></div> <span class="tr-meta svelte-1o4jdf5"> </span></div> <div class="flex items-center gap-2 flex-shrink-0 svelte-1o4jdf5"><!>  <button class="tr-share-btn svelte-1o4jdf5" title="Copy track link" aria-label="Share track"><!></button></div></div>`),at=A(`<div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 animate-pulse svelte-1o4jdf5"><div class="bg-black/75 border border-red-500/30 px-4 py-2 rounded text-[12px] font-mono tracking-widest text-red-500 font-bold uppercase shadow-[0_0_20px_rgba(239,68,68,0.3)] select-none svelte-1o4jdf5">NO SIGNAL</div></div>`),ot=A(`<button> </button>`),st=A(`<div class="visualizer-container fullscreen cursor-pointer svelte-1o4jdf5"><canvas class="visualizer-canvas svelte-1o4jdf5"></canvas> <!> <div class="visualizer-overlay svelte-1o4jdf5"><div class="flex items-center gap-1 bg-black/60 backdrop-blur-md rounded-lg p-1 border border-white/10 svelte-1o4jdf5"></div></div></div>`),ct=A(`<div class="arigato-modal-backdrop svelte-1o4jdf5"><div class="arigato-modal-content svelte-1o4jdf5"><header class="arigato-modal-header svelte-1o4jdf5"><h2 class="svelte-1o4jdf5">ARIGATO INFO</h2> <button class="arigato-close-btn svelte-1o4jdf5"><!></button></header> <div class="arigato-modal-body scroll-y svelte-1o4jdf5"><div class="merch-link-container svelte-1o4jdf5"><a href="https://nxnjaa.beatstars.com/" target="_blank" rel="noopener noreferrer" class="merch-link-btn svelte-1o4jdf5"><!> NXNJA MERCH & MUSIC</a></div> <p class="intro-text svelte-1o4jdf5"></p> <div class="tos-box svelte-1o4jdf5"><div class="tos-microtext svelte-1o4jdf5"></div></div> <p class="outro-text svelte-1o4jdf5"></p></div></div></div>`),lt=A(`<div class="mp-backdrop svelte-1o4jdf5"><div><header class="panel-header svelte-1o4jdf5"><div class="brand svelte-1o4jdf5"><button class="logo-btn svelte-1o4jdf5" aria-label="Open DOGS Info"><!></button> <h1 class="svelte-1o4jdf5"></h1></div> <button class="close-btn svelte-1o4jdf5" aria-label="Close panel"><!></button></header> <div class="mp-body svelte-1o4jdf5"><div class="songs-layout svelte-1o4jdf5"><div><div><div><!></div> <div class="track-info mt-2 svelte-1o4jdf5"><div class="flex items-center justify-center mb-1.5 svelte-1o4jdf5"><button class="player-share-btn svelte-1o4jdf5" title="Copy track link" aria-label="Share track"><!></button></div> <div><h2> </h2></div> <div><p> </p></div> <div><p> </p></div></div></div> <div class="player-controls-block svelte-1o4jdf5"><div class="progress-row svelte-1o4jdf5"><span class="ptime svelte-1o4jdf5"> </span> <div class="progress-wrap waveform-slider-wrap relative h-9 flex items-end svelte-1o4jdf5"><div class="waveform-bars flex items-end justify-between absolute inset-0 pointer-events-none px-1 h-full svelte-1o4jdf5"></div> <input type="range" class="seek-input absolute inset-0 opacity-0 cursor-pointer w-full h-full svelte-1o4jdf5" min="0" step="0.1" aria-label="Seek"/></div> <span class="ptime svelte-1o4jdf5"> </span></div> <div class="controls-row svelte-1o4jdf5"><button aria-label="Shuffle"><!></button> <button class="ctrl ctrl-md svelte-1o4jdf5" aria-label="Previous"><!></button> <button><!></button> <button class="ctrl ctrl-md svelte-1o4jdf5" aria-label="Next"><!></button> <button aria-label="Repeat"><!></button></div> <div class="w-full flex flex-col items-center gap-1.5 mt-2 px-1 svelte-1o4jdf5"><div><span><!> <span class="svelte-1o4jdf5">VOCAL</span></span> <div class="dj-fader-slot relative svelte-1o4jdf5"><div></div></div> <span><!> <span class="svelte-1o4jdf5">INST</span></span></div></div> <div class="relative flex justify-center items-center gap-3 mt-2 w-full svelte-1o4jdf5"><!> <div class="flex items-center gap-1.5 svelte-1o4jdf5"><button aria-label="Toggle Visualizer"><!></button> <button> </button></div> <div class="relative svelte-1o4jdf5"><button class="ctrl ctrl-xs vol-toggle-btn svelte-1o4jdf5" aria-label="Toggle volume slider"><!></button></div></div></div></div> <div><div class="mobile-close-bar hidden py-2 px-4 border-b border-white/5 flex items-center justify-between svelte-1o4jdf5"><span class="text-xs font-bold text-white/50 svelte-1o4jdf5">Track Library</span> <button class="px-3 py-1 bg-white/5 text-white/75 rounded-lg text-xs font-bold svelte-1o4jdf5">Back to player</button></div> <div class="tl-header flex justify-between items-center gap-3 svelte-1o4jdf5"><div class="flex items-center gap-2 svelte-1o4jdf5"><!><span class="svelte-1o4jdf5">TRACKS</span> <span class="tl-count svelte-1o4jdf5"> </span></div> <div class="flex items-center gap-1.5 ml-auto svelte-1o4jdf5"><span class="text-[9px] text-white/30 font-bold font-sans svelte-1o4jdf5">SORT BY:</span> <select class="bg-black/40 border border-white/10 rounded px-1.5 py-0.5 text-[10px] font-bold text-white/60 outline-none cursor-pointer hover:border-white/20 transition-all font-sans svelte-1o4jdf5"><option class="svelte-1o4jdf5">DEFAULT</option><option class="svelte-1o4jdf5">ARTIST</option><option class="svelte-1o4jdf5">ALBUM</option><option class="svelte-1o4jdf5">YEAR</option><option class="svelte-1o4jdf5">FILENAME</option><option class="svelte-1o4jdf5">GENRE</option><option class="svelte-1o4jdf5">SEASON</option></select></div></div> <div class="tracklist scroll-y svelte-1o4jdf5"></div></div></div></div> <footer class="mp-footer svelte-1o4jdf5"><div class="mp-status svelte-1o4jdf5"><span class="mp-dot svelte-1o4jdf5"></span><span class="svelte-1o4jdf5">🐕</span></div> <span class="svelte-1o4jdf5">MUSIC</span></footer></div> <!> <canvas class="fader-fx-canvas pointer-events-none svelte-1o4jdf5"></canvas> <!></div>`);function ut(O,A){oe(A,!0);let ke=`/img/error_cover.png`;function ut(e){e.target.src.endsWith(ke)||(e.target.src=ke)}let dt=i(A,`isClosing`,3,!1),ft=i(A,`initialTrackId`,3,null),I=o(`default`),L=o(!1),pt=o(!1),mt=o(!1),ht=o(null),gt=a(()=>!!F.fetchErrors[F.library[F.currentTrackIndex]?.id]),R=a(()=>F.isPlaying&&!dt()&&!S(gt)),z=o(!1),B=o(0),_t=o(!1),vt=o(null),V=null,H=!1,yt=o(!1),bt=o(!1),xt=a(()=>{let e=Be.split(/`{5,}/);return{intro:e[0]||``,tos:e[1]||``,outro:e[2]||``}});function St(e){if(!e)return``;let t=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`);return t=t.replace(/(https?:\/\/[^\s]+)/g,`<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>`),t=t.replace(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9._-]+)/g,`<a href="mailto:$1">$1</a>`),t.replace(/\n/g,`<br>`)}let Ct=a(()=>{let e=S(G);if(!e)return Array(60).fill(10);if(F.waveformPeaks[e.id])return F.waveformPeaks[e.id];let t=e.id,n=[],r=0;for(let e=0;e<t.length;e++)r=(r<<5)-r+t.charCodeAt(e),r|=0;let i=Math.abs(r)%1e3;for(let e=0;e<60;e++){let t=e/59,r=Math.sin(i+t*Math.PI*4),a=Math.cos(i*1.5+t*Math.PI*10)*.4,o=Math.sin(i*2.3+t*Math.PI*22)*.15,s=Math.abs(r+a+o)/1.55,c=Math.sin(t*Math.PI),l=(s*70+15)*c;n.push(Math.max(10,Math.round(l)))}return n});j(()=>{window.innerWidth<=640&&S(z)&&S(B)===0&&S(L)&&w(L,!1)}),j(()=>{F.isPlaying&&w(yt,!0)});let wt=a(()=>!F.isPlaying&&!S(yt)?ze.fragmentShader:Re[S(B)].fragmentShader);j(()=>{let e=F.analyser;return S(z)&&S(vt)&&!dt()&&(V=new Le(S(vt),e),V.init(S(wt)),V.start()),()=>{V&&(V.destroy(),V=null)}}),j(()=>{let e=S(wt);V&&S(z)&&(V.setPreset(e),V.start())}),j(()=>{S(L)?!history.state?.tracklistOpen&&!H&&(history.pushState({tracklistOpen:!0},``),H=!0):H&&(history.back(),H=!1)}),ue(()=>{H&&(history.back(),H=!1)});function Tt(e){!e.state?.tracklistOpen&&S(L)&&(w(L,!1),H=!1)}function Et(e){S(mt)&&S(ht)&&!S(ht).contains(e.target)&&!e.target.closest(`.vol-toggle-btn`)&&w(mt,!1)}let U=a(()=>Ne.unlocked?Pe:Pe.filter(e=>e.public!==!1));function Dt(e){return e.src?e.src.split(`/`).pop():``}function Ot(e){if(!e.dateAdded)return`Summer`;let t=new Date(e.dateAdded).getMonth();return t===11||t===0||t===1?`Winter`:t>=2&&t<=4?`Spring`:t>=5&&t<=7?`Summer`:`Fall`}let W=a(()=>{let e=[...S(U)];return S(I)===`artist`?e.sort((e,t)=>e.artist.localeCompare(t.artist)):S(I)===`album`?e.sort((e,t)=>e.album.localeCompare(t.album)):S(I)===`year`?e.sort((e,t)=>(e.year||0)-(t.year||0)):S(I)===`filename`?e.sort((e,t)=>Dt(e).localeCompare(Dt(t))):S(I)===`genre`?e.sort((e,t)=>(e.genre||``).localeCompare(t.genre||``)):S(I)===`season`&&e.sort((e,t)=>Ot(e).localeCompare(Ot(t))),e}),G=a(()=>S(U)[F.currentTrackIndex]??S(U)[0]);j(()=>{let e=S(U);if(F.library===e||F.library.length===0)return;let t=F.library[F.currentTrackIndex]?.id;F.init(e);let n=e.findIndex(e=>e.id===t);n===-1?(F.pause(),F.loadTrack(0,!1)):F.currentTrackIndex=n});let kt=o(0),At=o(0),jt=o(0),Mt=o(0),Nt=o(0),Pt=o(0),Ft=o(null),It=null;function Lt(e,t){e.stopPropagation();let n=`${window.location.origin}/music/${t.id}`;navigator.clipboard.writeText(n).then(()=>{w(Ft,t.id,!0),It&&clearTimeout(It),It=setTimeout(()=>{w(Ft,null)},2e3)}).catch(e=>{console.error(`Failed to copy share link:`,e)})}ue(()=>{It&&clearTimeout(It)}),be(()=>{if(Ne.revalidate(),F.init(S(U)),ft()){let e=S(U).findIndex(e=>e.id===ft());e!==-1&&F.loadTrack(e,!0)}else if(!F.hasPickedRandomTrack){F.hasPickedRandomTrack=!0;let e=Math.floor(Math.random()*S(U).length);F.loadTrack(e,!1)}});let K=o(null);function Rt(){let e=document.querySelector(`.track-row[data-track-id="${S(K)}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function zt(e){w(K,e.id,!0);let t=S(U).findIndex(t=>t.id===e.id);F.currentTrackIndex===t&&!F.fetchErrors[e.id]?F.togglePlay():F.loadTrack(t,!0)}function Bt(){window.innerWidth<=640?w(L,!0):w(z,!S(z))}function Vt(){let e=!F.isInstrumental;F.setCrossfade(e)||(te(J),S(Wt)||(w(Wt,!0),setTimeout(()=>{w(Wt,!1)},300)),S(J)===5?(en(),w(Gt,!0),setTimeout(()=>{w(Gt,!1)},150)):S(J)===10?en(35):S(J)>5&&S(J)<10?en(8):S(J)>10&&Math.random()<.4&&en(3))}function Ht(e){return!e||isNaN(e)?`0:00`:`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function Ut(e){let t=document.activeElement;if(!(t&&(t.tagName===`INPUT`||t.tagName===`TEXTAREA`||t.isContentEditable))){if(e.code===`Space`||e.key===` `)e.preventDefault(),F.togglePlay();else if(e.key===`ArrowDown`){if(S(W).length>0){e.preventDefault();let t=S(W).findIndex(e=>e.id===S(K));if(t===-1){let e=S(U)[F.currentTrackIndex];t=S(W).findIndex(t=>t.id===e?.id)}let n=(t+1)%S(W).length;w(K,S(W)[n].id,!0),Rt()}}else if(e.key===`ArrowUp`){if(S(W).length>0){e.preventDefault();let t=S(W).findIndex(e=>e.id===S(K));if(t===-1){let e=S(U)[F.currentTrackIndex];t=S(W).findIndex(t=>t.id===e?.id)}let n=(t-1+S(W).length)%S(W).length;w(K,S(W)[n].id,!0),Rt()}}else if(e.key===`Enter`&&S(K)){e.preventDefault();let t=S(W).find(e=>e.id===S(K));t&&zt(t)}}}let q=o(null),J=o(0),Wt=o(!1),Gt=o(!1),Y,X,Z,Q=[],$=[],Kt,qt=o(!1);j(()=>(S(q)&&Xt(),()=>{Kt&&cancelAnimationFrame(Kt),window.removeEventListener(`resize`,Zt),window.visualViewport?.removeEventListener(`resize`,Zt),Z&&(Z.dispose(),Z=null),Y=null,X=null,Q=[],$=[]})),j(()=>{if(F.currentTrackIndex,dt(),w(J,0),w(qt,!1),Y){for(let e of Q)Y.remove(e.mesh);for(let e of $)Y.remove(e.mesh)}Q=[],$=[]});function Jt(){if(!S(q))return{width:window.innerWidth,height:window.innerHeight};let e=S(q).getBoundingClientRect();return{width:e.width||window.innerWidth,height:e.height||window.innerHeight}}function Yt(){let{width:e,height:t}=Jt(),n=document.querySelector(`.dj-fader-knob`);if(!n)return{x:e/2,y:t/2};let r=S(q)?S(q).getBoundingClientRect():{left:0,top:0},i=n.getBoundingClientRect();return{x:i.left+i.width/2-r.left,y:t-(i.top+i.height/2-r.top)}}function Xt(){if(!S(q))return;let{width:e,height:t}=Jt();S(q).width=e,S(q).height=t,Y=new ne,X=new d(0,e,t,0,-1,1),Z=new se({canvas:S(q),alpha:!0,antialias:!0}),Z.setSize(e,t,!1),Z.setPixelRatio(Math.min(window.devicePixelRatio,2)),window.addEventListener(`resize`,Zt),window.visualViewport?.addEventListener(`resize`,Zt),Qt()}function Zt(){if(!S(q)||!Z||!X)return;let{width:e,height:t}=Jt();S(q).width=e,S(q).height=t,Z.setSize(e,t,!1),X.right=e,X.top=t,X.updateProjectionMatrix()}function Qt(){if(Kt=requestAnimationFrame(Qt),!(!Y||!X||!Z||!S(q))){if(S(J)>=10&&(w(qt,!0),Math.random()<.22)){let e=Yt();$t(e.x,e.y)}for(let e=Q.length-1;e>=0;e--){let t=Q[e];t.x+=t.vx,t.y+=t.vy,t.vy+=t.ay,t.life-=t.decay,t.mesh.position.set(t.x,t.y,0),t.mesh.material.opacity=t.life,t.life<=0&&(Y.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),Q.splice(e,1))}for(let e=$.length-1;e>=0;e--){let t=$[e];t.x+=t.vx,t.y+=t.vy,t.life-=t.decay;let n=t.startScale+(1-t.life)*88;t.mesh.scale.set(n,n,1),t.mesh.position.set(t.x,t.y,0),t.mesh.material.opacity=t.life*.16,t.life<=0&&(Y.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),$.splice(e,1))}Z.render(Y,X)}}function $t(e,t){if(!Y)return;let r=new ee(5,8),i=.85+Math.random()*.12,a=new _e(r,new h({color:new n(i,i,i*1.01),transparent:!0,opacity:.06,blending:1}));a.position.set(e,t,0),Y.add(a),$.push({mesh:a,x:e,y:t,vx:(Math.random()-.5)*.55+Math.sin(Date.now()*.001)*.22,vy:Math.random()*.7+1.25,startScale:1,life:1,decay:6e-4+Math.random()*4e-4})}function en(e=25){if(!Y||!S(q))return;let t=Yt(),r=t.x,i=t.y;for(let t=0;t<e;t++){let e=new _e(new ee(1.3,4),new h({color:new n(Math.random()<.4?16711765:16755200),transparent:!0,opacity:1,blending:2}));e.position.set(r,i,0),Y.add(e);let t=Math.random()*Math.PI*2,a=Math.random()*4+2;Q.push({mesh:e,x:r,y:i,vx:Math.cos(t)*a,vy:Math.sin(t)*a,ay:-.15,life:1,decay:.02+Math.random()*.02})}}var tn=lt();D(`keydown`,y,Ut),D(`popstate`,y,Tt),D(`click`,y,Et);var nn=r(tn);let rn;var an=r(nn),on=r(an),sn=r(on);Fe(r(sn),{size:`panel`}),e(sn);var cn=f(sn,2);cn.textContent=`MUSIC`,e(on);var ln=f(on,2);ve(r(ln),{size:20}),e(ln),e(an);var un=f(an,2),dn=r(un),fn=r(dn);let pn;var mn=r(fn);let hn;var gn=r(mn);let _n;var vn=r(gn),yn=t=>{var n=He(),i=r(n);p(i,e=>w(vt,e),()=>S(vt));var a=f(i,2),o=e=>{M(e,Ve())};N(a,e=>{!F.isPlaying&&!S(yt)&&e(o)});var s=f(a,2);pe(r(s),{size:16,class:`text-white/70`}),e(s),e(n),P(`click`,n,()=>{w(_t,!0)}),M(t,n)},bn=t=>{var n=Ue();pe(r(n),{size:16,class:`text-white/20`}),e(n),M(t,n)},xn=t=>{var n=xe(),i=c(n),o=t=>{var n=We(),i=r(n);let a;var o=f(r(i),8),s=r(o);let c;e(o),b(2),e(i);var l=f(i,2);let u;e(n),v(()=>{a=E(i,1,`vinyl-record svelte-1o4jdf5`,null,a,{spinning:S(R)}),C(s,`src`,F.fetchErrors[S(G).id]||!S(G).cover?ke:S(G).cover),C(s,`alt`,S(G).album),c=E(s,1,`record-art svelte-1o4jdf5`,null,c,{loaded:S(pt)}),u=E(l,1,`tonearm svelte-1o4jdf5`,null,u,{playing:S(R)})}),P(`click`,n,Bt),D(`load`,s,()=>w(pt,!0)),D(`error`,s,ut),Me(s),M(t,n)},s=t=>{let n=a(()=>F.duration>0?(1-F.currentTime/F.duration)*.45+.25:.48),i=a(()=>F.duration>0?F.currentTime/F.duration*.45+.25:.48);var o=Ge(),s=r(o),c=r(s),l=r(c),u=r(l,!0);e(l),b(2),e(c);var d=f(c,2),p=r(d);let m;var h=f(p,2);let g;var _=f(h,2);let y;var x=f(_,2);let ee;e(d),e(s),e(o),v(()=>{k(u,S(G).title),m=E(p,1,`spindle-left bg-zinc-900 svelte-1o4jdf5`,null,m,{spinning:S(R)}),g=E(h,1,`tape-roll-left bg-amber-950/70 svelte-1o4jdf5`,null,g,{spinning:S(R)}),T(h,`width: ${S(n)*46}px; height: ${S(n)*46}px;`),y=E(_,1,`spindle-right bg-zinc-900 svelte-1o4jdf5`,null,y,{spinning:S(R)}),ee=E(x,1,`tape-roll-right bg-amber-950/70 svelte-1o4jdf5`,null,ee,{spinning:S(R)}),T(x,`width: ${S(i)*46}px; height: ${S(i)*46}px;`)}),P(`click`,o,Bt),M(t,o)},l=t=>{var n=Ke(),i=r(n),a=f(r(i),4),o=f(r(a),4),s=r(o),c=r(s,!0);e(s);var l=f(s,2),u=r(l,!0);e(l),e(o),e(a);var d=f(a,2),p=r(d);let m;var h=f(p,2),g=r(h);let _;e(h),e(d);var y=f(d,2);let b;e(i),e(n),v(()=>{k(c,S(G).title),k(u,S(G).artist||`WEAREDOGS`),m=E(p,1,`floppy-shutter-slider bg-zinc-400 svelte-1o4jdf5`,null,m,{open:S(R)}),_=E(g,1,`floppy-magnetic-disc bg-zinc-900 svelte-1o4jdf5`,null,_,{spinning:S(R)}),b=E(y,1,`floppy-drive-led svelte-1o4jdf5`,null,b,{active:S(R)})}),P(`click`,n,Bt),M(t,n)},u=t=>{var n=Je(),i=r(n),a=r(i);let o;var s=f(a,2),c=r(s),l=r(c);let u;var d=f(l,2);let p;e(c);var m=f(c,2),h=r(m);let g;e(m);var _=f(m,2);he(_,20,()=>Array(10),ce,(e,t,n)=>{var r=qe();let i;v(e=>i=E(r,1,`comb-tooth svelte-1o4jdf5`,null,i,e),[()=>({vibrating:S(R)&&n%3==Math.floor(F.currentTime*4)%3})]),M(e,r)}),e(_),e(s),e(i),e(n),v(()=>{o=E(a,1,`music-box-key svelte-1o4jdf5`,null,o,{spinning:S(R)}),u=E(l,1,`music-box-gear gear-1 svelte-1o4jdf5`,null,u,{spinning:S(R)}),p=E(d,1,`music-box-gear gear-2 svelte-1o4jdf5`,null,p,{spinning:S(R)}),g=E(h,1,`music-box-drum bg-gradient-to-r from-amber-600 via-amber-500 to-amber-700 svelte-1o4jdf5`,null,g,{spinning:S(R)})}),P(`click`,n,Bt),M(t,n)};N(i,e=>{Ie.musicDeckModel===`vinyl`?e(o):Ie.musicDeckModel===`cassette`?e(s,1):Ie.musicDeckModel===`floppy`?e(l,2):Ie.musicDeckModel===`musicbox`&&e(u,3)}),M(t,n)};N(vn,e=>{S(z)&&!S(_t)?e(yn):S(z)&&S(_t)?e(bn,1):e(xn,-1)}),e(gn);var Sn=f(gn,2),Cn=r(Sn),wn=r(Cn),Tn=r(wn),En=e=>{me(e,{size:12,class:`text-[#22c55e]`})},Dn=e=>{m(e,{size:12})};N(Tn,e=>{S(Ft)===S(G).id?e(En):e(Dn,-1)}),e(wn),e(Cn);var On=f(Cn,2);let kn;var An=r(On);let jn;var Mn=r(An,!0);e(An),e(On);var Nn=f(On,2);let Pn;var Fn=r(Nn);let In;var Ln=r(Fn,!0);e(Fn),e(Nn);var Rn=f(Nn,2);let zn;var Bn=r(Rn);let Vn;var Hn=r(Bn,!0);e(Bn),e(Rn),e(Sn),e(mn);var Un=f(mn,2),Wn=r(Un),Gn=r(Wn),Kn=r(Gn,!0);e(Gn);var qn=f(Gn,2),Jn=r(qn);he(Jn,21,()=>S(Ct),ce,(e,t,n)=>{let r=a(()=>F.duration>0?F.currentTime/F.duration:0),i=a(()=>n/60);var o=Ye();let s;v(()=>{s=E(o,1,`waveform-bar transition-colors duration-100 rounded-full svelte-1o4jdf5`,null,s,{active:S(i)<=S(r)}),T(o,`height: ${S(t)??``}%; width: 3px;`)}),M(e,o)}),e(Jn);var Yn=f(Jn,2);s(Yn),e(qn);var Xn=f(qn,2),Zn=r(Xn,!0);e(Xn),e(Wn);var Qn=f(Wn,2),$n=r(Qn);let er;g(r($n),{size:15}),e($n);var tr=f($n,2);ye(r(tr),{size:19}),e(tr);var nr=f(tr,2);let rr;var ir=r(nr),ar=e=>{je(e,{size:22})},or=e=>{M(e,Xe())},sr=e=>{Se(e,{size:22,fill:`currentColor`})},cr=e=>{fe(e,{size:22,fill:`currentColor`})};N(ir,e=>{F.fetchErrors[S(G).id]?e(ar):F.isLoading?e(or,1):F.isPlaying?e(sr,2):e(cr,-1)}),e(nr);var lr=f(nr,2);t(r(lr),{size:19}),e(lr);var ur=f(lr,2);let dr;var fr=r(ur),pr=e=>{l(e,{size:15})},mr=e=>{Oe(e,{size:15})},hr=e=>{Te(e,{size:15})};N(fr,e=>{F.repeatMode===2?e(pr):F.repeatMode===3?e(mr,1):e(hr,-1)}),e(ur),e(Qn);var gr=f(Qn,2),_r=r(gr);let vr;var yr=r(_r);let br;de(r(yr),{size:12}),b(2),e(yr);var xr=f(yr,2),Sr=r(xr);let Cr;e(xr);var wr=f(xr,2);let Tr;_(r(wr),{size:12}),b(2),e(wr),e(_r),e(gr);var Er=f(gr,2),Dr=r(Er),Or=t=>{var n=Ze(),i=r(n),a=r(i),o=e=>{ge(e,{size:12,class:`text-red-400`})},c=e=>{le(e,{size:12})};N(a,e=>{F.isMuted||F.volume===0?e(o):e(c,-1)}),e(i);var l=f(i,2);s(l);var d=f(l,2),m=r(d);e(d),e(n),p(n,e=>w(ht,e),()=>S(ht)),v(e=>{u(l,F.volume),k(m,`${e??``}%`)},[()=>Math.round(F.volume*100)]),P(`click`,i,()=>F.toggleMute()),P(`input`,l,e=>F.setVolume(parseFloat(e.target.value))),M(t,n)};N(Dr,e=>{S(mt)&&e(Or)});var kr=f(Dr,2),Ar=r(kr);let jr;Ce(r(Ar),{size:13}),e(Ar);var Mr=f(Ar,2),Nr=r(Mr,!0);e(Mr),e(kr);var Pr=f(kr,2),Fr=r(Pr),Ir=r(Fr),Lr=e=>{ge(e,{size:13,class:`text-red-400`})},Rr=e=>{le(e,{size:13})};N(Ir,e=>{F.isMuted||F.volume===0?e(Lr):e(Rr,-1)}),e(Fr),e(Pr),e(Er),e(Un),e(fn);var zr=f(fn,2);let Br;var Vr=r(zr),Hr=f(r(Vr),2);e(Vr);var Ur=f(Vr,2),Wr=r(Ur),Gr=r(Wr);Ae(Gr,{size:13});var Kr=f(Gr,3),qr=r(Kr,!0);e(Kr),e(Wr);var Jr=f(Wr,2),Yr=f(r(Jr),2),Xr=r(Yr);Xr.value=Xr.__value=`default`;var Zr=f(Xr);Zr.value=Zr.__value=`artist`;var Qr=f(Zr);Qr.value=Qr.__value=`album`;var $r=f(Qr);$r.value=$r.__value=`year`;var ei=f($r);ei.value=ei.__value=`filename`;var ti=f(ei);ti.value=ti.__value=`genre`;var ni=f(ti);ni.value=ni.__value=`season`,e(Yr),e(Jr),e(Ur);var ri=f(Ur,2);he(ri,21,()=>S(W),ce,(t,n,i)=>{var a=it();let o;var s=r(a),c=r(s),l=e=>{M(e,Qe())},u=e=>{var t=$e();t.textContent=i+1,M(e,t)};N(c,e=>{S(G).id===S(n).id&&F.isPlaying?e(l):e(u,-1)}),e(s);var d=f(s,2),p=f(d,2),h=r(p),g=r(h);let _;var y=r(g,!0);e(g);var x=f(g,2),ee=t=>{var n=et();je(r(n),{size:10}),b(),e(n),M(t,n)};N(x,e=>{F.fetchErrors[S(n).id]&&e(ee)}),e(h);var te=f(h,2),ne=r(te);e(te),e(p);var re=f(p,2),ie=r(re),T=t=>{var i=rt(),a=r(i),o=e=>{var t=tt();P(`click`,t,e=>{e.stopPropagation(),w(bt,!0)}),M(e,t)},s=e=>{var t=nt();v(()=>C(t,`href`,S(n).attrib)),P(`click`,t,e=>e.stopPropagation()),M(e,t)};N(a,e=>{S(n).id===`arigato`?e(o):e(s,-1)}),e(i),M(t,i)};N(ie,e=>{S(n).attrib&&e(T)});var ae=f(ie,2),oe=r(ae),se=e=>{me(e,{size:12,class:`text-[#22c55e]`})},ce=e=>{m(e,{size:12})};N(oe,e=>{S(Ft)===S(n).id?e(se):e(ce,-1)}),e(ae),e(re),e(a),v(()=>{o=E(a,1,`track-row svelte-1o4jdf5`,null,o,{active:S(G).id===S(n).id,"kb-focused":S(K)===S(n).id,"fetch-error":F.fetchErrors[S(n).id]}),C(a,`data-track-id`,S(n).id),C(d,`src`,F.fetchErrors[S(n).id]||!S(n).cover?ke:S(n).cover),C(d,`alt`,S(n).album),_=E(g,1,`tr-title svelte-1o4jdf5`,null,_,{"line-through":F.fetchErrors[S(n).id],"opacity-50":F.fetchErrors[S(n).id]}),k(y,S(n).title),k(ne,`${S(n).artist??``} · ${S(n).album??``} (${(S(n).year||``)??``})`)}),P(`click`,a,()=>zt(S(n))),D(`error`,d,ut),Me(d),P(`click`,ae,e=>Lt(e,S(n))),M(t,a)}),e(ri),e(zr),e(dn),e(un),b(2),e(nn);var ii=f(nn,2),ai=t=>{var n=st(),i=r(n);p(i,e=>w(vt,e),()=>S(vt));var a=f(i,2),o=e=>{M(e,at())};N(a,e=>{!F.isPlaying&&!S(yt)&&e(o)});var s=f(a,2),c=r(s);he(c,21,()=>Re,ce,(t,n,i)=>{var a=ot(),o=r(a,!0);e(a),v(()=>{E(a,1,`px-2 py-1 rounded text-[9px] font-bold transition-all uppercase tracking-wider font-mono
                ${S(B)===i?`bg-purple-600 text-white`:`text-white/40 hover:text-white/80`}`,`svelte-1o4jdf5`),k(o,S(n).name)}),P(`click`,a,()=>w(B,i,!0)),M(t,a)}),e(c),e(s),e(n),P(`click`,n,e=>{e.stopPropagation(),w(_t,!1)}),P(`click`,s,e=>e.stopPropagation()),M(t,n)};N(ii,e=>{S(z)&&S(_t)&&e(ai)});var oi=f(ii,2);p(oi,e=>w(q,e),()=>S(q));var si=f(oi,2),ci=t=>{var n=ct(),i=r(n),a=r(i),o=f(r(a),2);ve(r(o),{size:16}),e(o),e(a);var s=f(a,2),c=r(s),l=r(c);ae(r(l),{size:14}),b(),e(l),e(c);var u=f(c,2);Ee(u,()=>St(S(xt).intro),!0),e(u);var d=f(u,2),p=r(d);Ee(p,()=>St(S(xt).tos),!0),e(p),e(d);var m=f(d,2);Ee(m,()=>St(S(xt).outro),!0),e(m),e(s),e(i),e(n),P(`click`,n,()=>w(bt,!1)),P(`click`,i,e=>e.stopPropagation()),P(`click`,o,()=>w(bt,!1)),De(3,n,()=>re,()=>({duration:150})),M(t,n)};N(si,e=>{S(bt)&&e(ci)}),e(tn),v((e,t)=>{rn=E(nn,1,`mp-container svelte-1o4jdf5`,null,rn,{closing:dt(),"theme-inst":F.isInstrumental}),pn=E(fn,1,`player-side svelte-1o4jdf5`,null,pn,{"tracklist-open":S(L)}),hn=E(mn,1,`player-top-block transition-all duration-300 ease-in-out svelte-1o4jdf5`,null,hn,{"opacity-0":S(L),"scale-95":S(L),"pointer-events-none":S(L)}),_n=E(gn,1,`vinyl-wrapper relative overflow-hidden svelte-1o4jdf5`,null,_n,{"deck-glitch":S(gt)}),kn=E(On,1,`scroll-container svelte-1o4jdf5`,null,kn,{overflowing:S(At)>S(kt)}),T(On,`--scroll-dist: -${S(At)-S(kt)}px`),jn=E(An,1,`track-title scroll-text svelte-1o4jdf5`,null,jn,{"animate-scroll":S(At)>S(kt)}),k(Mn,S(G).title),Pn=E(Nn,1,`scroll-container svelte-1o4jdf5`,null,Pn,{overflowing:S(Mt)>S(jt)}),T(Nn,`--scroll-dist: -${S(Mt)-S(jt)}px`),In=E(Fn,1,`track-artist scroll-text svelte-1o4jdf5`,null,In,{"animate-scroll":S(Mt)>S(jt)}),k(Ln,S(G).artist),zn=E(Rn,1,`scroll-container svelte-1o4jdf5`,null,zn,{overflowing:S(Pt)>S(Nt)}),T(Rn,`--scroll-dist: -${S(Pt)-S(Nt)}px`),Vn=E(Bn,1,`track-album scroll-text svelte-1o4jdf5`,null,Vn,{"animate-scroll":S(Pt)>S(Nt)}),k(Hn,S(G).album),k(Kn,e),C(Yn,`max`,F.duration||100),u(Yn,F.currentTime),k(Zn,t),er=E($n,1,`ctrl ctrl-sm svelte-1o4jdf5`,null,er,{"active-ctrl":F.isShuffled}),rr=E(nr,1,`ctrl ctrl-play svelte-1o4jdf5`,null,rr,{"ctrl-error":F.fetchErrors[S(G).id]}),C(nr,`aria-label`,F.isPlaying?`Pause`:`Play`),dr=E(ur,1,`ctrl ctrl-sm svelte-1o4jdf5`,null,dr,{"active-ctrl":F.repeatMode>0}),C(ur,`title`,F.repeatMode===1?`Repeat: all`:F.repeatMode===2?`Repeat: one`:F.repeatMode===3?`Stop after current track`:`Repeat: off`),vr=E(_r,1,`dj-crossfader svelte-1o4jdf5`,null,vr,{"fader-flash":S(Gt),"fader-fried":S(J)>=10}),br=E(yr,1,`fader-label left-label flex items-center gap-1 svelte-1o4jdf5`,null,br,{active:!F.isInstrumental}),Cr=E(Sr,1,`dj-fader-knob svelte-1o4jdf5`,null,Cr,{right:F.isInstrumental,"knob-jiggle":S(Wt),fried:S(J)>=10}),Tr=E(wr,1,`fader-label right-label flex items-center gap-1 svelte-1o4jdf5`,null,Tr,{active:F.isInstrumental}),jr=E(Ar,1,`ctrl ctrl-xs svelte-1o4jdf5`,null,jr,{"active-ctrl":S(z)}),E(Mr,1,`w-[90px] h-[20px] flex items-center justify-center rounded text-[9px] font-bold transition-all font-mono uppercase tracking-wider select-none cursor-pointer
                      ${S(z)?`bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 hover:border-white/25 active:scale-95`:`bg-transparent border border-white/5 text-white/20 hover:text-white/40 hover:border-white/10`}`,`svelte-1o4jdf5`),C(Mr,`title`,S(z)?`Click to cycle presets`:`Click to enable visualizer`),k(Nr,Re[S(B)].name),Br=E(zr,1,`tracklist-side svelte-1o4jdf5`,null,Br,{"show-mobile":S(L)}),k(qr,S(U).length)},[()=>Ht(F.currentTime),()=>Ht(F.duration)]),P(`click`,tn,function(...e){A.onClose?.apply(this,e)}),P(`click`,nn,e=>e.stopPropagation()),P(`click`,sn,()=>{F.isPlaying||window.dispatchEvent(new CustomEvent(`open-info-panel`))}),P(`click`,ln,function(...e){A.onClose?.apply(this,e)}),P(`click`,wn,e=>Lt(e,S(G))),x(An,`clientWidth`,e=>w(At,e)),x(On,`clientWidth`,e=>w(kt,e)),x(Fn,`clientWidth`,e=>w(Mt,e)),x(Nn,`clientWidth`,e=>w(jt,e)),x(Bn,`clientWidth`,e=>w(Pt,e)),x(Rn,`clientWidth`,e=>w(Nt,e)),P(`input`,Yn,e=>{F.seek(parseFloat(e.target.value))}),P(`change`,Yn,e=>{F.isPlaying||F.play(parseFloat(e.target.value))}),P(`click`,$n,()=>F.setShuffle(!F.isShuffled)),P(`click`,tr,()=>F.prevTrack()),P(`click`,nr,()=>F.togglePlay()),P(`click`,lr,()=>F.nextTrack()),P(`click`,ur,()=>{F.repeatMode=(F.repeatMode+1)%4}),P(`click`,_r,Vt),P(`click`,Ar,()=>{w(z,!S(z))}),P(`click`,Mr,()=>{S(z)?w(B,(S(B)+1)%Re.length):w(z,!0)}),P(`click`,Fr,()=>{w(mt,!S(mt))}),P(`click`,Hr,()=>{w(L,!1)}),we(Yr,()=>S(I),e=>w(I,e)),De(1,dn,()=>re,()=>({duration:120,delay:120})),De(2,dn,()=>re,()=>({duration:120})),M(O,tn),ie()}ke([`click`,`input`,`change`]);export{ut as default};