...
`,Ve=O(`<div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 animate-pulse svelte-1o4jdf5"><div class="bg-black/75 border border-red-500/30 px-3 py-1.5 rounded text-[10px] font-mono tracking-widest text-red-500 font-bold uppercase shadow-[0_0_15px_rgba(239,68,68,0.25)] select-none svelte-1o4jdf5">NO SIGNAL</div></div>`),He=O(`<div class="visualizer-container cursor-pointer svelte-1o4jdf5"><canvas class="visualizer-canvas svelte-1o4jdf5"></canvas> <!> <div class="visualizer-hover-overlay svelte-1o4jdf5"><!></div></div>`),Ue=O(`<div class="visualizer-container bg-[#050508]/40 border border-white/5 flex items-center justify-center svelte-1o4jdf5"><!></div>`),We=O(`<div class="vinyl-record-clicker cursor-pointer w-full h-full svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div><div class="groove g1 svelte-1o4jdf5"></div> <div class="groove g2 svelte-1o4jdf5"></div> <div class="groove g3 svelte-1o4jdf5"></div> <div class="groove g4 svelte-1o4jdf5"></div> <div class="record-label svelte-1o4jdf5"><img loading="lazy"/></div> <div class="spindle svelte-1o4jdf5"></div></div> <div></div></div>`),Ge=O(`<div class="cassette-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="cassette-tape svelte-1o4jdf5"><div class="cassette-label bg-gradient-to-r from-purple-800 to-pink-700 svelte-1o4jdf5"><span class="cassette-track-title svelte-1o4jdf5"> </span> <span class="cassette-brand svelte-1o4jdf5">WEAREDOGS AUDIO</span></div> <div class="cassette-window bg-zinc-950/80 svelte-1o4jdf5"><div></div> <div></div> <div></div> <div></div></div></div></div>`),Ke=O(`<div class="floppy-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="floppy-disk svelte-1o4jdf5"><div class="floppy-corner svelte-1o4jdf5"></div> <div class="floppy-write-protect svelte-1o4jdf5"></div> <div class="floppy-label bg-slate-100 text-slate-900 svelte-1o4jdf5"><div class="floppy-label-stripe bg-red-600 svelte-1o4jdf5"></div> <div class="floppy-label-stripe-blue bg-blue-600 svelte-1o4jdf5"></div> <div class="floppy-label-content svelte-1o4jdf5"><div class="floppy-song truncate font-mono svelte-1o4jdf5"> </div> <div class="floppy-artist truncate font-mono svelte-1o4jdf5"> </div></div></div> <div class="floppy-shutter-door bg-zinc-700 svelte-1o4jdf5"><div></div> <div class="floppy-shutter-opening bg-zinc-950 svelte-1o4jdf5"><div></div></div></div> <div></div></div></div>`),qe=O(`<div></div>`),Je=O(`<div class="musicbox-container-clicker cursor-pointer w-full h-full flex items-center justify-center p-4 relative svelte-1o4jdf5" role="button" tabindex="0" aria-label="Open tracklist"><div class="music-box svelte-1o4jdf5"><div></div> <div class="music-box-interior border border-amber-900/40 svelte-1o4jdf5"><div class="music-box-gears svelte-1o4jdf5"><div></div> <div></div></div> <div class="music-box-drum-wrap svelte-1o4jdf5"><div><div class="music-box-pins svelte-1o4jdf5"><div class="pin pin-1 svelte-1o4jdf5"></div> <div class="pin pin-2 svelte-1o4jdf5"></div> <div class="pin pin-3 svelte-1o4jdf5"></div> <div class="pin pin-4 svelte-1o4jdf5"></div> <div class="pin pin-5 svelte-1o4jdf5"></div> <div class="pin pin-6 svelte-1o4jdf5"></div></div></div></div> <div class="music-box-comb svelte-1o4jdf5"></div></div></div></div>`),Ye=O(`<span></span>`),Xe=O(`<div class="spin-ring svelte-1o4jdf5"></div>`),Ze=O(`<div class="volume-popover svelte-1o4jdf5"><button class="ctrl ctrl-xs mr-2 border border-white/10 rounded-full p-1 hover:bg-white/10 svelte-1o4jdf5" aria-label="Mute"><!></button> <input type="range" class="vol-slider-pop svelte-1o4jdf5" min="0" max="1" step="0.01" aria-label="Volume"/> <span class="text-[10px] font-bold text-white/60 min-w-[28px] text-right font-mono select-none svelte-1o4jdf5"> </span></div>`),Qe=O(`<div class="eq svelte-1o4jdf5"><div class="eq-b svelte-1o4jdf5"></div> <div class="eq-b svelte-1o4jdf5"></div> <div class="eq-b svelte-1o4jdf5"></div></div>`),$e=O(`<span class="svelte-1o4jdf5"></span>`),et=O(`<span class="text-amber-400 flex items-center gap-1 text-[9px] font-bold tracking-wider uppercase bg-amber-500/10 px-1.5 py-0.5 rounded flex-shrink-0 svelte-1o4jdf5" title="Failed to fetch music source from remote database"><!> Error Fetching</span>`),tt=O(`<button class="cursor-pointer svelte-1o4jdf5" style="background: none; border: none; padding: 0; color: inherit; font: inherit;">i</button>`),nt=O(`<a target="_blank" class="svelte-1o4jdf5">i</a>`),rt=O(`<span class="inst-chip-link svelte-1o4jdf5"><!></span>`),it=O(`<div><div class="tr-num svelte-1o4jdf5"><!></div> <img loading="lazy" class="tr-art svelte-1o4jdf5"/> <div class="tr-info svelte-1o4jdf5"><div class="flex items-center gap-1.5 min-w-0 svelte-1o4jdf5"><span> </span> <!></div> <span class="tr-meta svelte-1o4jdf5"> </span></div> <div class="flex items-center gap-2 flex-shrink-0 svelte-1o4jdf5"><!>  <button class="tr-share-btn svelte-1o4jdf5" title="Copy track link" aria-label="Share track"><!></button></div></div>`),at=O(`<div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none z-10 animate-pulse svelte-1o4jdf5"><div class="bg-black/75 border border-red-500/30 px-4 py-2 rounded text-[12px] font-mono tracking-widest text-red-500 font-bold uppercase shadow-[0_0_20px_rgba(239,68,68,0.3)] select-none svelte-1o4jdf5">NO SIGNAL</div></div>`),ot=O(`<button> </button>`),st=O(`<div class="visualizer-container fullscreen cursor-pointer svelte-1o4jdf5"><canvas class="visualizer-canvas svelte-1o4jdf5"></canvas> <!> <div class="visualizer-overlay svelte-1o4jdf5"><div class="flex items-center gap-1 bg-black/60 backdrop-blur-md rounded-lg p-1 border border-white/10 svelte-1o4jdf5"></div></div></div>`),ct=O(`<div class="arigato-modal-backdrop svelte-1o4jdf5"><div class="arigato-modal-content svelte-1o4jdf5"><header class="arigato-modal-header svelte-1o4jdf5"><h2 class="svelte-1o4jdf5">ARIGATO INFO</h2> <button class="arigato-close-btn svelte-1o4jdf5"><!></button></header> <div class="arigato-modal-body scroll-y svelte-1o4jdf5"><div class="merch-link-container svelte-1o4jdf5"><a href="https://nxnjaa.beatstars.com/" target="_blank" rel="noopener noreferrer" class="merch-link-btn svelte-1o4jdf5"><!> NXNJA MERCH & MUSIC</a></div> <p class="intro-text svelte-1o4jdf5"></p> <div class="tos-box svelte-1o4jdf5"><div class="tos-microtext svelte-1o4jdf5"></div></div> <p class="outro-text svelte-1o4jdf5"></p></div></div></div>`),lt=O(`<div class="mp-backdrop svelte-1o4jdf5"><div><header class="panel-header svelte-1o4jdf5"><div class="brand svelte-1o4jdf5"><button class="logo-btn svelte-1o4jdf5" aria-label="Open DOGS Info"><!></button> <h1 class="svelte-1o4jdf5"></h1></div> <button class="close-btn svelte-1o4jdf5" aria-label="Close panel"><!></button></header> <div class="mp-body svelte-1o4jdf5"><div class="songs-layout svelte-1o4jdf5"><div><div><div class="vinyl-wrapper relative overflow-hidden svelte-1o4jdf5"><!></div> <div class="track-info mt-2 svelte-1o4jdf5"><div class="flex items-center justify-center mb-1.5 svelte-1o4jdf5"><button class="player-share-btn svelte-1o4jdf5" title="Copy track link" aria-label="Share track"><!></button></div> <div><h2> </h2></div> <div><p> </p></div> <div><p> </p></div></div></div> <div class="player-controls-block svelte-1o4jdf5"><div class="progress-row svelte-1o4jdf5"><span class="ptime svelte-1o4jdf5"> </span> <div class="progress-wrap waveform-slider-wrap relative h-9 flex items-end svelte-1o4jdf5"><div class="waveform-bars flex items-end justify-between absolute inset-0 pointer-events-none px-1 h-full svelte-1o4jdf5"></div> <input type="range" class="seek-input absolute inset-0 opacity-0 cursor-pointer w-full h-full svelte-1o4jdf5" min="0" step="0.1" aria-label="Seek"/></div> <span class="ptime svelte-1o4jdf5"> </span></div> <div class="controls-row svelte-1o4jdf5"><button aria-label="Shuffle"><!></button> <button class="ctrl ctrl-md svelte-1o4jdf5" aria-label="Previous"><!></button> <button><!></button> <button class="ctrl ctrl-md svelte-1o4jdf5" aria-label="Next"><!></button> <button aria-label="Repeat"><!></button></div> <div class="w-full flex flex-col items-center gap-1.5 mt-2 px-1 svelte-1o4jdf5"><div><span><!> <span class="svelte-1o4jdf5">VOCAL</span></span> <div class="dj-fader-slot relative svelte-1o4jdf5"><div></div></div> <span><!> <span class="svelte-1o4jdf5">INST</span></span></div></div> <div class="relative flex justify-center items-center gap-3 mt-2 w-full svelte-1o4jdf5"><!> <div class="flex items-center gap-1.5 svelte-1o4jdf5"><button aria-label="Toggle Visualizer"><!></button> <button> </button></div> <div class="relative svelte-1o4jdf5"><button class="ctrl ctrl-xs vol-toggle-btn svelte-1o4jdf5" aria-label="Toggle volume slider"><!></button></div></div></div></div> <div><div class="mobile-close-bar hidden py-2 px-4 border-b border-white/5 flex items-center justify-between svelte-1o4jdf5"><span class="text-xs font-bold text-white/50 svelte-1o4jdf5">Track Library</span> <button class="px-3 py-1 bg-white/5 text-white/75 rounded-lg text-xs font-bold svelte-1o4jdf5">Back to player</button></div> <div class="tl-header flex justify-between items-center gap-3 svelte-1o4jdf5"><div class="flex items-center gap-2 svelte-1o4jdf5"><!><span class="svelte-1o4jdf5">TRACKS</span> <span class="tl-count svelte-1o4jdf5"> </span></div> <div class="flex items-center gap-1.5 ml-auto svelte-1o4jdf5"><span class="text-[9px] text-white/30 font-bold font-sans svelte-1o4jdf5">SORT BY:</span> <select class="bg-black/40 border border-white/10 rounded px-1.5 py-0.5 text-[10px] font-bold text-white/60 outline-none cursor-pointer hover:border-white/20 transition-all font-sans svelte-1o4jdf5"><option class="svelte-1o4jdf5">DEFAULT</option><option class="svelte-1o4jdf5">ARTIST</option><option class="svelte-1o4jdf5">ALBUM</option><option class="svelte-1o4jdf5">YEAR</option><option class="svelte-1o4jdf5">FILENAME</option><option class="svelte-1o4jdf5">GENRE</option><option class="svelte-1o4jdf5">SEASON</option></select></div></div> <div class="tracklist scroll-y svelte-1o4jdf5"></div></div></div></div> <footer class="mp-footer svelte-1o4jdf5"><div class="mp-status svelte-1o4jdf5"><span class="mp-dot svelte-1o4jdf5"></span><span class="svelte-1o4jdf5">🐕</span></div> <span class="svelte-1o4jdf5">MUSIC</span></footer></div> <!> <canvas class="fader-fx-canvas pointer-events-none svelte-1o4jdf5"></canvas> <!></div>`);function ut(S,O){r(O,!0);let Te=`/img/error_cover.png`;function ut(e){e.target.src.endsWith(Te)||(e.target.src=Te)}let dt=ke(O,`isClosing`,3,!1),ft=ke(O,`initialTrackId`,3,null),F=k(`default`),I=k(!1),pt=k(!1),mt=k(!1),ht=k(null),L=x(()=>P.isPlaying&&!dt()),R=k(!1),z=k(0),gt=k(!1),B=k(null),V=null,H=!1,_t=k(!1),vt=k(!1),yt=x(()=>{let e=Be.split(/`{5,}/);return{intro:e[0]||``,tos:e[1]||``,outro:e[2]||``}});function bt(e){if(!e)return``;let t=e.replace(/&/g,`&amp;`).replace(/</g,`&lt;`).replace(/>/g,`&gt;`);return t=t.replace(/(https?:\/\/[^\s]+)/g,`<a href="$1" target="_blank" rel="noopener noreferrer">$1</a>`),t=t.replace(/([a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+\.[a-zA-Z0-9._-]+)/g,`<a href="mailto:$1">$1</a>`),t.replace(/\n/g,`<br>`)}let xt=x(()=>{let e=D(G);if(!e)return Array(60).fill(10);if(P.waveformPeaks[e.id])return P.waveformPeaks[e.id];let t=e.id,n=[],r=0;for(let e=0;e<t.length;e++)r=(r<<5)-r+t.charCodeAt(e),r|=0;let i=Math.abs(r)%1e3;for(let e=0;e<60;e++){let t=e/59,r=Math.sin(i+t*Math.PI*4),a=Math.cos(i*1.5+t*Math.PI*10)*.4,o=Math.sin(i*2.3+t*Math.PI*22)*.15,s=Math.abs(r+a+o)/1.55,c=Math.sin(t*Math.PI),l=(s*70+15)*c;n.push(Math.max(10,Math.round(l)))}return n});M(()=>{window.innerWidth<=640&&D(R)&&D(z)===0&&D(I)&&t(I,!1)}),M(()=>{P.isPlaying&&t(_t,!0)});let St=x(()=>!P.isPlaying&&!D(_t)?ze.fragmentShader:Re[D(z)].fragmentShader);M(()=>{let e=P.analyser;return D(R)&&D(B)&&!dt()&&(V=new Le(D(B),e),V.init(D(St)),V.start()),()=>{V&&(V.destroy(),V=null)}}),M(()=>{let e=D(St);V&&D(R)&&(V.setPreset(e),V.start())}),M(()=>{D(I)?!history.state?.tracklistOpen&&!H&&(history.pushState({tracklistOpen:!0},``),H=!0):H&&(history.back(),H=!1)}),fe(()=>{H&&(history.back(),H=!1)});function Ct(e){!e.state?.tracklistOpen&&D(I)&&(t(I,!1),H=!1)}function wt(e){D(mt)&&D(ht)&&!D(ht).contains(e.target)&&!e.target.closest(`.vol-toggle-btn`)&&t(mt,!1)}let U=x(()=>Ne.unlocked?Ie:Ie.filter(e=>e.public!==!1));function Tt(e){return e.src?e.src.split(`/`).pop():``}function Et(e){if(!e.dateAdded)return`Summer`;let t=new Date(e.dateAdded).getMonth();return t===11||t===0||t===1?`Winter`:t>=2&&t<=4?`Spring`:t>=5&&t<=7?`Summer`:`Fall`}let W=x(()=>{let e=[...D(U)];return D(F)===`artist`?e.sort((e,t)=>e.artist.localeCompare(t.artist)):D(F)===`album`?e.sort((e,t)=>e.album.localeCompare(t.album)):D(F)===`year`?e.sort((e,t)=>(e.year||0)-(t.year||0)):D(F)===`filename`?e.sort((e,t)=>Tt(e).localeCompare(Tt(t))):D(F)===`genre`?e.sort((e,t)=>(e.genre||``).localeCompare(t.genre||``)):D(F)===`season`&&e.sort((e,t)=>Et(e).localeCompare(Et(t))),e}),G=x(()=>D(U)[P.currentTrackIndex]??D(U)[0]);M(()=>{let e=D(U);if(P.library===e||P.library.length===0)return;let t=P.library[P.currentTrackIndex]?.id;P.init(e);let n=e.findIndex(e=>e.id===t);n===-1?(P.pause(),P.loadTrack(0,!1)):P.currentTrackIndex=n});let Dt=k(0),Ot=k(0),kt=k(0),At=k(0),jt=k(0),Mt=k(0),Nt=k(null),Pt=null;function Ft(e,n){e.stopPropagation();let r=`${window.location.origin}/music/${n.id}`;navigator.clipboard.writeText(r).then(()=>{t(Nt,n.id,!0),Pt&&clearTimeout(Pt),Pt=setTimeout(()=>{t(Nt,null)},2e3)}).catch(e=>{console.error(`Failed to copy share link:`,e)})}fe(()=>{Pt&&clearTimeout(Pt)}),re(()=>{if(Ne.revalidate(),P.init(D(U)),ft()){let e=D(U).findIndex(e=>e.id===ft());e!==-1&&P.loadTrack(e,!0)}else if(!P.hasPickedRandomTrack){P.hasPickedRandomTrack=!0;let e=Math.floor(Math.random()*D(U).length);P.loadTrack(e,!1)}});let K=k(null);function It(){let e=document.querySelector(`.track-row[data-track-id="${D(K)}"]`);e&&e.scrollIntoView({block:`nearest`,behavior:`smooth`})}function Lt(e){t(K,e.id,!0);let n=D(U).findIndex(t=>t.id===e.id);P.currentTrackIndex===n&&!P.fetchErrors[e.id]?P.togglePlay():P.loadTrack(n,!0)}function Rt(){window.innerWidth<=640?t(I,!0):t(R,!D(R))}function zt(){let e=!P.isInstrumental;P.setCrossfade(e)||(te(J),D(Ht)||(t(Ht,!0),setTimeout(()=>{t(Ht,!1)},300)),D(J)===5?(Zt(),t(Ut,!0),setTimeout(()=>{t(Ut,!1)},150)):D(J)===10?Zt(35):D(J)>5&&D(J)<10?Zt(8):D(J)>10&&Math.random()<.4&&Zt(3))}function Bt(e){return!e||isNaN(e)?`0:00`:`${Math.floor(e/60)}:${Math.floor(e%60).toString().padStart(2,`0`)}`}function Vt(e){let n=document.activeElement;if(!(n&&(n.tagName===`INPUT`||n.tagName===`TEXTAREA`||n.isContentEditable))){if(e.code===`Space`||e.key===` `)e.preventDefault(),P.togglePlay();else if(e.key===`ArrowDown`){if(D(W).length>0){e.preventDefault();let n=D(W).findIndex(e=>e.id===D(K));if(n===-1){let e=D(U)[P.currentTrackIndex];n=D(W).findIndex(t=>t.id===e?.id)}let r=(n+1)%D(W).length;t(K,D(W)[r].id,!0),It()}}else if(e.key===`ArrowUp`){if(D(W).length>0){e.preventDefault();let n=D(W).findIndex(e=>e.id===D(K));if(n===-1){let e=D(U)[P.currentTrackIndex];n=D(W).findIndex(t=>t.id===e?.id)}let r=(n-1+D(W).length)%D(W).length;t(K,D(W)[r].id,!0),It()}}else if(e.key===`Enter`&&D(K)){e.preventDefault();let t=D(W).find(e=>e.id===D(K));t&&Lt(t)}}}let q=k(null),J=k(0),Ht=k(!1),Ut=k(!1),Y,X,Z,Q=[],$=[],Wt,Gt=k(!1);M(()=>(D(q)&&qt(),()=>{Wt&&cancelAnimationFrame(Wt),window.removeEventListener(`resize`,Jt),Z&&(Z.dispose(),Z=null),Y=null,X=null,Q=[],$=[]})),M(()=>{if(P.currentTrackIndex,dt(),t(J,0),t(Gt,!1),Y){for(let e of Q)Y.remove(e.mesh);for(let e of $)Y.remove(e.mesh)}Q=[],$=[]});function Kt(){let e=document.querySelector(`.dj-fader-knob`);if(!e)return{x:window.innerWidth/2,y:window.innerHeight/2};let t=e.getBoundingClientRect();return{x:t.left+t.width/2,y:window.innerHeight-(t.top+t.height/2)}}function qt(){if(!D(q))return;let e=window.innerWidth,t=window.innerHeight;D(q).width=e,D(q).height=t,Y=new ie,X=new p(0,e,t,0,-1,1),Z=new pe({canvas:D(q),alpha:!0,antialias:!0}),Z.setSize(e,t,!1),Z.setPixelRatio(Math.min(window.devicePixelRatio,2)),window.addEventListener(`resize`,Jt),Yt()}function Jt(){if(!D(q)||!Z||!X)return;let e=window.innerWidth,t=window.innerHeight;D(q).width=e,D(q).height=t,Z.setSize(e,t,!1),X.right=e,X.top=t,X.updateProjectionMatrix()}function Yt(){if(Wt=requestAnimationFrame(Yt),!(!Y||!X||!Z||!D(q))){if(D(J)>=10&&(t(Gt,!0),Math.random()<.22)){let e=Kt();Xt(e.x,e.y)}for(let e=Q.length-1;e>=0;e--){let t=Q[e];t.x+=t.vx,t.y+=t.vy,t.vy+=t.ay,t.life-=t.decay,t.mesh.position.set(t.x,t.y,0),t.mesh.material.opacity=t.life,t.life<=0&&(Y.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),Q.splice(e,1))}for(let e=$.length-1;e>=0;e--){let t=$[e];t.x+=t.vx,t.y+=t.vy,t.life-=t.decay;let n=t.startScale+(1-t.life)*88;t.mesh.scale.set(n,n,1),t.mesh.position.set(t.x,t.y,0),t.mesh.material.opacity=t.life*.16,t.life<=0&&(Y.remove(t.mesh),t.mesh.geometry.dispose(),t.mesh.material.dispose(),$.splice(e,1))}Z.render(Y,X)}}function Xt(e,t){if(!Y)return;let n=new o(5,8),r=.85+Math.random()*.12,i=new ve(n,new ee({color:new Oe(r,r,r*1.01),transparent:!0,opacity:.06,blending:1}));i.position.set(e,t,0),Y.add(i),$.push({mesh:i,x:e,y:t,vx:(Math.random()-.5)*.55+Math.sin(Date.now()*.001)*.22,vy:Math.random()*.7+1.25,startScale:1,life:1,decay:6e-4+Math.random()*4e-4})}function Zt(e=25){if(!Y||!D(q))return;let t=Kt(),n=t.x,r=t.y;for(let t=0;t<e;t++){let e=new ve(new o(1.3,4),new ee({color:new Oe(Math.random()<.4?16711765:16755200),transparent:!0,opacity:1,blending:2}));e.position.set(n,r,0),Y.add(e);let t=Math.random()*Math.PI*2,i=Math.random()*4+2;Q.push({mesh:e,x:n,y:r,vx:Math.cos(t)*i,vy:Math.sin(t)*i,ay:-.15,life:1,decay:.02+Math.random()*.02})}}var Qt=lt();be(`keydown`,s,Vt),be(`popstate`,s,Ct),be(`click`,s,wt);var $t=N(Qt);let en;var tn=N($t),nn=N(tn),rn=N(nn);Pe(N(rn),{size:`panel`}),h(rn);var an=u(rn,2);an.textContent=`MUSIC`,h(nn);var on=u(nn,2);he(N(on),{size:20}),h(on),h(tn);var sn=u(tn,2),cn=N(sn),ln=N(cn);let un;var dn=N(ln);let fn;var pn=N(dn),mn=N(pn),hn=e=>{var n=He(),r=N(n);f(r,e=>t(B,e),()=>D(B));var i=u(r,2),a=e=>{A(e,Ve())};w(i,e=>{!P.isPlaying&&!D(_t)&&e(a)});var o=u(i,2);me(N(o),{size:16,class:`text-white/70`}),h(o),h(n),E(`click`,n,()=>{t(gt,!0)}),A(e,n)},gn=e=>{var t=Ue();me(N(t),{size:16,class:`text-white/20`}),h(t),A(e,t)},_n=e=>{var n=we(),r=ae(n),a=e=>{var n=We(),r=N(n);let a;var o=u(N(r),8),s=N(o);let c;h(o),C(2),h(r);var l=u(r,2);let d;h(n),T(()=>{a=i(r,1,`vinyl-record svelte-1o4jdf5`,null,a,{spinning:D(L)}),b(s,`src`,P.fetchErrors[D(G).id]||!D(G).cover?Te:D(G).cover),b(s,`alt`,D(G).album),c=i(s,1,`record-art svelte-1o4jdf5`,null,c,{loaded:D(pt)}),d=i(l,1,`tonearm svelte-1o4jdf5`,null,d,{playing:D(L)})}),E(`click`,n,Rt),be(`load`,s,()=>t(pt,!0)),be(`error`,s,ut),De(s),A(e,n)},o=e=>{let t=x(()=>P.duration>0?(1-P.currentTime/P.duration)*.45+.25:.48),n=x(()=>P.duration>0?P.currentTime/P.duration*.45+.25:.48);var r=Ge(),a=N(r),o=N(a),s=N(o),c=N(s,!0);h(s),C(2),h(o);var l=u(o,2),d=N(l);let f;var p=u(d,2);let m;var g=u(p,2);let _;var v=u(g,2);let y;h(l),h(a),h(r),T(()=>{j(c,D(G).title),f=i(d,1,`spindle-left bg-zinc-900 svelte-1o4jdf5`,null,f,{spinning:D(L)}),m=i(p,1,`tape-roll-left bg-amber-950/70 svelte-1o4jdf5`,null,m,{spinning:D(L)}),Me(p,`width: ${D(t)*46}px; height: ${D(t)*46}px;`),_=i(g,1,`spindle-right bg-zinc-900 svelte-1o4jdf5`,null,_,{spinning:D(L)}),y=i(v,1,`tape-roll-right bg-amber-950/70 svelte-1o4jdf5`,null,y,{spinning:D(L)}),Me(v,`width: ${D(n)*46}px; height: ${D(n)*46}px;`)}),E(`click`,r,Rt),A(e,r)},s=e=>{var t=Ke(),n=N(t),r=u(N(n),4),a=u(N(r),4),o=N(a),s=N(o,!0);h(o);var c=u(o,2),l=N(c,!0);h(c),h(a),h(r);var d=u(r,2),f=N(d);let p;var m=u(f,2),g=N(m);let _;h(m),h(d);var v=u(d,2);let y;h(n),h(t),T(()=>{j(s,D(G).title),j(l,D(G).artist||`WEAREDOGS`),p=i(f,1,`floppy-shutter-slider bg-zinc-400 svelte-1o4jdf5`,null,p,{open:D(L)}),_=i(g,1,`floppy-magnetic-disc bg-zinc-900 svelte-1o4jdf5`,null,_,{spinning:D(L)}),y=i(v,1,`floppy-drive-led svelte-1o4jdf5`,null,y,{active:D(L)})}),E(`click`,t,Rt),A(e,t)},c=e=>{var t=Je(),n=N(t),r=N(n);let a;var o=u(r,2),s=N(o),c=N(s);let l;var d=u(c,2);let f;h(s);var p=u(s,2),m=N(p);let g;h(p);var _=u(p,2);Se(_,20,()=>Array(10),v,(e,t,n)=>{var r=qe();let a;T(e=>a=i(r,1,`comb-tooth svelte-1o4jdf5`,null,a,e),[()=>({vibrating:D(L)&&n%3==Math.floor(P.currentTime*4)%3})]),A(e,r)}),h(_),h(o),h(n),h(t),T(()=>{a=i(r,1,`music-box-key svelte-1o4jdf5`,null,a,{spinning:D(L)}),l=i(c,1,`music-box-gear gear-1 svelte-1o4jdf5`,null,l,{spinning:D(L)}),f=i(d,1,`music-box-gear gear-2 svelte-1o4jdf5`,null,f,{spinning:D(L)}),g=i(m,1,`music-box-drum bg-gradient-to-r from-amber-600 via-amber-500 to-amber-700 svelte-1o4jdf5`,null,g,{spinning:D(L)})}),E(`click`,t,Rt),A(e,t)};w(r,e=>{Fe.musicDeckModel===`vinyl`?e(a):Fe.musicDeckModel===`cassette`?e(o,1):Fe.musicDeckModel===`floppy`?e(s,2):Fe.musicDeckModel===`musicbox`&&e(c,3)}),A(e,n)};w(mn,e=>{D(R)&&!D(gt)?e(hn):D(R)&&D(gt)?e(gn,1):e(_n,-1)}),h(pn);var vn=u(pn,2),yn=N(vn),bn=N(yn),xn=N(bn),Sn=e=>{xe(e,{size:12,class:`text-[#22c55e]`})},Cn=e=>{n(e,{size:12})};w(xn,e=>{D(Nt)===D(G).id?e(Sn):e(Cn,-1)}),h(bn),h(yn);var wn=u(yn,2);let Tn;var En=N(wn);let Dn;var On=N(En,!0);h(En),h(wn);var kn=u(wn,2);let An;var jn=N(kn);let Mn;var Nn=N(jn,!0);h(jn),h(kn);var Pn=u(kn,2);let Fn;var In=N(Pn);let Ln;var Rn=N(In,!0);h(In),h(Pn),h(vn),h(dn);var zn=u(dn,2),Bn=N(zn),Vn=N(Bn),Hn=N(Vn,!0);h(Vn);var Un=u(Vn,2),Wn=N(Un);Se(Wn,21,()=>D(xt),v,(e,t,n)=>{let r=x(()=>P.duration>0?P.currentTime/P.duration:0),a=x(()=>n/60);var o=Ye();let s;T(()=>{s=i(o,1,`waveform-bar transition-colors duration-100 rounded-full svelte-1o4jdf5`,null,s,{active:D(a)<=D(r)}),Me(o,`height: ${D(t)??``}%; width: 3px;`)}),A(e,o)}),h(Wn);var Gn=u(Wn,2);ye(Gn),h(Un);var Kn=u(Un,2),qn=N(Kn,!0);h(Kn),h(Bn);var Jn=u(Bn,2),Yn=N(Jn);let Xn;oe(N(Yn),{size:15}),h(Yn);var Zn=u(Yn,2);Ae(N(Zn),{size:19}),h(Zn);var Qn=u(Zn,2);let $n;var er=N(Qn),tr=e=>{_e(e,{size:22})},nr=e=>{A(e,Xe())},rr=e=>{de(e,{size:22,fill:`currentColor`})},ir=e=>{Ce(e,{size:22,fill:`currentColor`})};w(er,e=>{P.fetchErrors[D(G).id]?e(tr):P.isLoading?e(nr,1):P.isPlaying?e(rr,2):e(ir,-1)}),h(Qn);var ar=u(Qn,2);c(N(ar),{size:19}),h(ar);var or=u(ar,2);let sr;var cr=N(or),lr=e=>{se(e,{size:15})},ur=e=>{a(e,{size:15})};w(cr,e=>{P.repeatMode===2?e(lr):e(ur,-1)}),h(or),h(Jn);var dr=u(Jn,2),fr=N(dr);let pr;var mr=N(fr);let hr;Ee(N(mr),{size:12}),C(2),h(mr);var gr=u(mr,2),_r=N(gr);let vr;h(gr);var yr=u(gr,2);let br;d(N(yr),{size:12}),C(2),h(yr),h(fr),h(dr);var xr=u(dr,2),Sr=N(xr),Cr=n=>{var r=Ze(),i=N(r),a=N(i),o=e=>{ne(e,{size:12,class:`text-red-400`})},s=t=>{e(t,{size:12})};w(a,e=>{P.isMuted||P.volume===0?e(o):e(s,-1)}),h(i);var c=u(i,2);ye(c);var l=u(c,2),d=N(l);h(l),h(r),f(r,e=>t(ht,e),()=>D(ht)),T(e=>{m(c,P.volume),j(d,`${e??``}%`)},[()=>Math.round(P.volume*100)]),E(`click`,i,()=>P.toggleMute()),E(`input`,c,e=>P.setVolume(parseFloat(e.target.value))),A(n,r)};w(Sr,e=>{D(mt)&&e(Cr)});var wr=u(Sr,2),Tr=N(wr);let Er;ue(N(Tr),{size:13}),h(Tr);var Dr=u(Tr,2),Or=N(Dr,!0);h(Dr),h(wr);var kr=u(wr,2),Ar=N(kr),jr=N(Ar),Mr=e=>{ne(e,{size:13,class:`text-red-400`})},Nr=t=>{e(t,{size:13})};w(jr,e=>{P.isMuted||P.volume===0?e(Mr):e(Nr,-1)}),h(Ar),h(kr),h(xr),h(zn),h(ln);var Pr=u(ln,2);let Fr;var Ir=N(Pr),Lr=u(N(Ir),2);h(Ir);var Rr=u(Ir,2),zr=N(Rr),Br=N(zr);ge(Br,{size:13});var Vr=u(Br,3),Hr=N(Vr,!0);h(Vr),h(zr);var Ur=u(zr,2),Wr=u(N(Ur),2),Gr=N(Wr);Gr.value=Gr.__value=`default`;var Kr=u(Gr);Kr.value=Kr.__value=`artist`;var qr=u(Kr);qr.value=qr.__value=`album`;var Jr=u(qr);Jr.value=Jr.__value=`year`;var Yr=u(Jr);Yr.value=Yr.__value=`filename`;var Xr=u(Yr);Xr.value=Xr.__value=`genre`;var Zr=u(Xr);Zr.value=Zr.__value=`season`,h(Wr),h(Ur),h(Rr);var Qr=u(Rr,2);Se(Qr,21,()=>D(W),v,(e,r,a)=>{var o=it();let s;var c=N(o),l=N(c),d=e=>{A(e,Qe())},f=e=>{var t=$e();t.textContent=a+1,A(e,t)};w(l,e=>{D(G).id===D(r).id&&P.isPlaying?e(d):e(f,-1)}),h(c);var p=u(c,2),m=u(p,2),g=N(m),_=N(g);let v;var y=N(_,!0);h(_);var ee=u(_,2),te=e=>{var t=et();_e(N(t),{size:10}),C(),h(t),A(e,t)};w(ee,e=>{P.fetchErrors[D(r).id]&&e(te)}),h(g);var x=u(g,2),ne=N(x);h(x),h(m);var re=u(m,2),ie=N(re),ae=e=>{var n=rt(),i=N(n),a=e=>{var n=tt();E(`click`,n,e=>{e.stopPropagation(),t(vt,!0)}),A(e,n)},o=e=>{var t=nt();T(()=>b(t,`href`,D(r).attrib)),E(`click`,t,e=>e.stopPropagation()),A(e,t)};w(i,e=>{D(r).id===`arigato`?e(a):e(o,-1)}),h(n),A(e,n)};w(ie,e=>{D(r).attrib&&e(ae)});var oe=u(ie,2),S=N(oe),se=e=>{xe(e,{size:12,class:`text-[#22c55e]`})},ce=e=>{n(e,{size:12})};w(S,e=>{D(Nt)===D(r).id?e(se):e(ce,-1)}),h(oe),h(re),h(o),T(()=>{s=i(o,1,`track-row svelte-1o4jdf5`,null,s,{active:D(G).id===D(r).id,"kb-focused":D(K)===D(r).id,"fetch-error":P.fetchErrors[D(r).id]}),b(o,`data-track-id`,D(r).id),b(p,`src`,P.fetchErrors[D(r).id]||!D(r).cover?Te:D(r).cover),b(p,`alt`,D(r).album),v=i(_,1,`tr-title svelte-1o4jdf5`,null,v,{"line-through":P.fetchErrors[D(r).id],"opacity-50":P.fetchErrors[D(r).id]}),j(y,D(r).title),j(ne,`${D(r).artist??``} · ${D(r).album??``} (${(D(r).year||``)??``})`)}),E(`click`,o,()=>Lt(D(r))),be(`error`,p,ut),De(p),E(`click`,oe,e=>Ft(e,D(r))),A(e,o)}),h(Qr),h(Pr),h(cn),h(sn),C(2),h($t);var $r=u($t,2),ei=e=>{var n=st(),r=N(n);f(r,e=>t(B,e),()=>D(B));var a=u(r,2),o=e=>{A(e,at())};w(a,e=>{!P.isPlaying&&!D(_t)&&e(o)});var s=u(a,2),c=N(s);Se(c,21,()=>Re,v,(e,n,r)=>{var a=ot(),o=N(a,!0);h(a),T(()=>{i(a,1,`px-2 py-1 rounded text-[9px] font-bold transition-all uppercase tracking-wider font-mono
                ${D(z)===r?`bg-purple-600 text-white`:`text-white/40 hover:text-white/80`}`,`svelte-1o4jdf5`),j(o,D(n).name)}),E(`click`,a,()=>t(z,r,!0)),A(e,a)}),h(c),h(s),h(n),E(`click`,n,e=>{e.stopPropagation(),t(gt,!1)}),E(`click`,s,e=>e.stopPropagation()),A(e,n)};w($r,e=>{D(R)&&D(gt)&&e(ei)});var ti=u($r,2);f(ti,e=>t(q,e),()=>D(q));var ni=u(ti,2),ri=e=>{var n=ct(),r=N(n),i=N(r),a=u(N(i),2);he(N(a),{size:16}),h(a),h(i);var o=u(i,2),s=N(o),c=N(s);g(N(c),{size:14}),C(),h(c),h(s);var l=u(s,2);y(l,()=>bt(D(yt).intro),!0),h(l);var d=u(l,2),f=N(d);y(f,()=>bt(D(yt).tos),!0),h(f),h(d);var p=u(d,2);y(p,()=>bt(D(yt).outro),!0),h(p),h(o),h(r),h(n),E(`click`,n,()=>t(vt,!1)),E(`click`,r,e=>e.stopPropagation()),E(`click`,a,()=>t(vt,!1)),le(3,n,()=>ce,()=>({duration:150})),A(e,n)};w(ni,e=>{D(vt)&&e(ri)}),h(Qt),T((e,t)=>{en=i($t,1,`mp-container svelte-1o4jdf5`,null,en,{closing:dt(),"theme-inst":P.isInstrumental}),un=i(ln,1,`player-side svelte-1o4jdf5`,null,un,{"tracklist-open":D(I)}),fn=i(dn,1,`player-top-block transition-all duration-300 ease-in-out svelte-1o4jdf5`,null,fn,{"opacity-0":D(I),"scale-95":D(I),"pointer-events-none":D(I)}),Tn=i(wn,1,`scroll-container svelte-1o4jdf5`,null,Tn,{overflowing:D(Ot)>D(Dt)}),Me(wn,`--scroll-dist: -${D(Ot)-D(Dt)}px`),Dn=i(En,1,`track-title scroll-text svelte-1o4jdf5`,null,Dn,{"animate-scroll":D(Ot)>D(Dt)}),j(On,D(G).title),An=i(kn,1,`scroll-container svelte-1o4jdf5`,null,An,{overflowing:D(At)>D(kt)}),Me(kn,`--scroll-dist: -${D(At)-D(kt)}px`),Mn=i(jn,1,`track-artist scroll-text svelte-1o4jdf5`,null,Mn,{"animate-scroll":D(At)>D(kt)}),j(Nn,D(G).artist),Fn=i(Pn,1,`scroll-container svelte-1o4jdf5`,null,Fn,{overflowing:D(Mt)>D(jt)}),Me(Pn,`--scroll-dist: -${D(Mt)-D(jt)}px`),Ln=i(In,1,`track-album scroll-text svelte-1o4jdf5`,null,Ln,{"animate-scroll":D(Mt)>D(jt)}),j(Rn,D(G).album),j(Hn,e),b(Gn,`max`,P.duration||100),m(Gn,P.currentTime),j(qn,t),Xn=i(Yn,1,`ctrl ctrl-sm svelte-1o4jdf5`,null,Xn,{"active-ctrl":P.isShuffled}),$n=i(Qn,1,`ctrl ctrl-play svelte-1o4jdf5`,null,$n,{"ctrl-error":P.fetchErrors[D(G).id]}),b(Qn,`aria-label`,P.isPlaying?`Pause`:`Play`),sr=i(or,1,`ctrl ctrl-sm svelte-1o4jdf5`,null,sr,{"active-ctrl":P.repeatMode>0}),pr=i(fr,1,`dj-crossfader svelte-1o4jdf5`,null,pr,{"fader-flash":D(Ut),"fader-fried":D(J)>=10}),hr=i(mr,1,`fader-label left-label flex items-center gap-1 svelte-1o4jdf5`,null,hr,{active:!P.isInstrumental}),vr=i(_r,1,`dj-fader-knob svelte-1o4jdf5`,null,vr,{right:P.isInstrumental,"knob-jiggle":D(Ht),fried:D(J)>=10}),br=i(yr,1,`fader-label right-label flex items-center gap-1 svelte-1o4jdf5`,null,br,{active:P.isInstrumental}),Er=i(Tr,1,`ctrl ctrl-xs svelte-1o4jdf5`,null,Er,{"active-ctrl":D(R)}),i(Dr,1,`w-[90px] h-[20px] flex items-center justify-center rounded text-[9px] font-bold transition-all font-mono uppercase tracking-wider select-none cursor-pointer
                      ${D(R)?`bg-white/5 border border-white/10 text-white/70 hover:text-white hover:bg-white/10 hover:border-white/25 active:scale-95`:`bg-transparent border border-white/5 text-white/20 hover:text-white/40 hover:border-white/10`}`,`svelte-1o4jdf5`),b(Dr,`title`,D(R)?`Click to cycle presets`:`Click to enable visualizer`),j(Or,Re[D(z)].name),Fr=i(Pr,1,`tracklist-side svelte-1o4jdf5`,null,Fr,{"show-mobile":D(I)}),j(Hr,D(U).length)},[()=>Bt(P.currentTime),()=>Bt(P.duration)]),E(`click`,Qt,function(...e){O.onClose?.apply(this,e)}),E(`click`,$t,e=>e.stopPropagation()),E(`click`,rn,()=>{P.isPlaying||window.dispatchEvent(new CustomEvent(`open-info-panel`))}),E(`click`,on,function(...e){O.onClose?.apply(this,e)}),E(`click`,bn,e=>Ft(e,D(G))),l(En,`clientWidth`,e=>t(Ot,e)),l(wn,`clientWidth`,e=>t(Dt,e)),l(jn,`clientWidth`,e=>t(At,e)),l(kn,`clientWidth`,e=>t(kt,e)),l(In,`clientWidth`,e=>t(Mt,e)),l(Pn,`clientWidth`,e=>t(jt,e)),E(`input`,Gn,e=>{P.seek(parseFloat(e.target.value))}),E(`change`,Gn,e=>{P.isPlaying||P.play(parseFloat(e.target.value))}),E(`click`,Yn,()=>P.setShuffle(!P.isShuffled)),E(`click`,Zn,()=>P.prevTrack()),E(`click`,Qn,()=>P.togglePlay()),E(`click`,ar,()=>P.nextTrack()),E(`click`,or,()=>{P.repeatMode=(P.repeatMode+1)%3}),E(`click`,fr,zt),E(`click`,Tr,()=>{t(R,!D(R))}),E(`click`,Dr,()=>{D(R)?t(z,(D(z)+1)%Re.length):t(R,!0)}),E(`click`,Ar,()=>{t(mt,!D(mt))}),E(`click`,Lr,()=>{t(I,!1)}),_(Wr,()=>D(F),e=>t(F,e)),le(1,cn,()=>ce,()=>({duration:120,delay:120})),le(2,cn,()=>ce,()=>({duration:120})),A(S,Qt),je()}Te([`click`,`input`,`change`]);export{ut as default};